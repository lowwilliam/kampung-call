...
export function create1963AlfaRomeoGiuliaSpiderModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const attachment_hood_8 = {"parentId": "front-clip", "parentSocket": "socket-front-clip-hood", "localStart": [0, 0, 0], "localEnd": [0.76, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_hood_8 = makeAttachmentEndpoint(attachment_hood_8);
  const node_hood_8 = new THREE.Group();
  node_hood_8.name = "Hinged long bonnet__pivot";
  if (endpoint_hood_8) {
    node_hood_8.position.copy(endpoint_hood_8.start);
    node_hood_8.rotation.set(0, 0, 0);
    node_hood_8.scale.set(1, 1, 1);
  } else {
    node_hood_8.position.set(0.94, 1.0, 0.0);
    node_hood_8.rotation.set(0.0, 0.0, 0.0);
    node_hood_8.scale.set(1.0, 1.0, 1.0);
  }
  node_hood_8.userData.sculptComponent = {"id": "hood", "name": "Hinged long bonnet", "level": "meso", "role": "hinged panel", "importance": 0.78, "confidence": 0.88, "primitive": "curve-sweep", "topologyClass": "conforming-shell", "topologyRationale": "Hinged long bonnet is represented as conforming-shell because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "conforming-shell procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["longitudinal crown", "nose taper"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "front-clip", "attachment": {"parentId": "front-clip", "parentSocket": "socket-front-clip-hood", "localStart": [0, 0, 0], "localEnd": [0.76, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 1.52, "height": 0.12, "depth": 1.12, "units": "m", "confidence": 0.88}, "transform": {"position": [0.94, 1, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "hinge", "pivot": {"mode": "component-origin", "localPosition": [-0.75, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-hood", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.52, 0.12, 1.12], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "hood", "seamRefs": ["hood-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}}, "material": "body-paint", "materialLayers": ["body-paint"], "deformations": ["longitudinal crown", "nose taper"], "joints": [], "seams": ["hood-gap"], "localFeatures": [{"id": "hood-spear", "type": "ridge", "description": "Tapered chrome spear centered along the hood crown", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "hood-perimeter-seam", "type": "seam", "description": "Narrow recessed gap tracing the separate hood panel", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(8, 10, 9, 1)", "secondaryAlbedo": "rgba(17, 21, 19, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_hood_8.userData.actionProfile = {"animationRole": "hinge", "pivot": {"mode": "component-origin", "localPosition": [-0.75, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-hood", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.52, 0.12, 1.12], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "hood", "seamRefs": ["hood-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}};
  (nodes["front-clip"] ?? root).add(node_hood_8);
  nodes["hood"] = node_hood_8;
  const mesh_hood_8Geometry = endpoint_hood_8
    ? new THREE.CylinderGeometry(endpoint_hood_8.endRadius, endpoint_hood_8.baseRadius, endpoint_hood_8.length, 32, 12)
    : buildCurveSweepGeometry({"spine": [[-0.5, -0.4, 0.0], [-0.1, 0.1, 0.0], [0.3, 0.2, 0.0], [0.6, -0.1, 0.0]], "crossSection": {"points": [[-0.04, -0.02], [0.04, -0.02], [0.04, 0.02], [-0.04, 0.02]]}, "closed": false});
  const mesh_hood_8 = new THREE.Mesh(
    mesh_hood_8Geometry,
    materialMap["body-paint"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_hood_8.name = "Hinged long bonnet";
  if (endpoint_hood_8) {
    mesh_hood_8.position.copy(endpoint_hood_8.midpoint);
    mesh_hood_8.quaternion.copy(endpoint_hood_8.quaternion);
  }
  mesh_hood_8.castShadow = options.castShadow ?? true;
  mesh_hood_8.receiveShadow = options.receiveShadow ?? true;
  mesh_hood_8.userData.sculptComponent = {"id": "hood", "name": "Hinged long bonnet", "level": "meso", "role": "hinged panel", "importance": 0.78, "confidence": 0.88, "primitive": "curve-sweep", "topologyClass": "conforming-shell", "topologyRationale": "Hinged long bonnet is represented as conforming-shell because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "conforming-shell procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["longitudinal crown", "nose taper"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "front-clip", "attachment": {"parentId": "front-clip", "parentSocket": "socket-front-clip-hood", "localStart": [0, 0, 0], "localEnd": [0.76, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 1.52, "height": 0.12, "depth": 1.12, "units": "m", "confidence": 0.88}, "transform": {"position": [0.94, 1, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "hinge", "pivot": {"mode": "component-origin", "localPosition": [-0.75, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-hood", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.52, 0.12, 1.12], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "hood", "seamRefs": ["hood-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}}, "material": "body-paint", "materialLayers": ["body-paint"], "deformations": ["longitudinal crown", "nose taper"], "joints": [], "seams": ["hood-gap"], "localFeatures": [{"id": "hood-spear", "type": "ridge", "description": "Tapered chrome spear centered along the hood crown", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "hood-perimeter-seam", "type": "seam", "description": "Narrow recessed gap tracing the separate hood panel", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(8, 10, 9, 1)", "secondaryAlbedo": "rgba(17, 21, 19, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_hood_8.add(mesh_hood_8);
  meshes["hood"] = mesh_hood_8;
  ...
  destructionGroups["hood"].push(node_hood_8);
  ...
  node_hood_8.add(socket_hood_socket_hood_0);
  sockets["hood:socket-hood"] = socket_hood_socket_hood_0;

  const attachment_trunk_lid_9 = {"parentId": "rear-deck", "parentSocket": "socket-rear-deck-trunk-lid", "localStart": [0, 0, 0], "localEnd": [0.39, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_trunk_lid_9 = makeAttachmentEndpoint(attachment_trunk_lid_9);
  const node_trunk_lid_9 = new THREE.Group();
  node_trunk_lid_9.name = "Rounded trunk lid__pivot";
  if (endpoint_trunk_lid_9) {
    node_trunk_lid_9.position.copy(endpoint_trunk_lid_9.start);
    node_trunk_lid_9.rotation.set(0, 0, 0);
    node_trunk_lid_9.scale.set(1, 1, 1);
  } else {
    node_trunk_lid_9.position.set(-1.34, 0.98, 0.0);
    node_trunk_lid_9.rotation.set(0.0, 0.0, 0.0);
    node_trunk_lid_9.scale.set(1.0, 1.0, 1.0);
  }
  node_trunk_lid_9.userData.sculptComponent = {"id": "trunk-lid", "name": "Rounded trunk lid", "level": "meso", "role": "hinged panel", "importance": 0.78, "confidence": 0.88, "primitive": "curve-sweep", "topologyClass": "conforming-shell", "topologyRationale": "Rounded trunk lid is represented as conforming-shell because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "conforming-shell procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "rear-deck", "attachment": {"parentId": "rear-deck", "parentSocket": "socket-rear-deck-trunk-lid", "localStart": [0, 0, 0], "localEnd": [0.39, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.78, "height": 0.1, "depth": 1.04, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.34, 0.98, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "hinge", "pivot": {"mode": "component-origin", "localPosition": [0.36, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-trunk-lid", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.78, 0.1, 1.04], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "trunk-lid", "seamRefs": ["trunk-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}}, "material": "body-paint", "materialLayers": ["body-paint"], "deformations": [], "joints": [], "seams": ["trunk-gap"], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(8, 10, 9, 1)", "secondaryAlbedo": "rgba(17, 21, 19, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_trunk_lid_9.userData.actionProfile = {"animationRole": "hinge", "pivot": {"mode": "component-origin", "localPosition": [0.36, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-trunk-lid", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.78, 0.1, 1.04], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "trunk-lid", "seamRefs": ["trunk-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}};
  (nodes["rear-deck"] ?? root).add(node_trunk_lid_9);
  nodes["trunk-lid"] = node_trunk_lid_9;
  const mesh_trunk_lid_9Geometry = endpoint_trunk_lid_9
    ? new THREE.CylinderGeometry(endpoint_trunk_lid_9.endRadius, endpoint_trunk_lid_9.baseRadius, endpoint_trunk_lid_9.length, 32, 12)
    : buildCurveSweepGeometry({"spine": [[-0.5, -0.4, 0.0], [-0.1, 0.1, 0.0], [0.3, 0.2, 0.0], [0.6, -0.1, 0.0]], "crossSection": {"points": [[-0.04, -0.02], [0.04, -0.02], [0.04, 0.02], [-0.04, 0.02]]}, "closed": false});
  const mesh_trunk_lid_9 = new THREE.Mesh(
    mesh_trunk_lid_9Geometry,
    materialMap["body-paint"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_trunk_lid_9.name = "Rounded trunk lid";
  if (endpoint_trunk_lid_9) {
    mesh_trunk_lid_9.position.copy(endpoint_trunk_lid_9.midpoint);
    mesh_trunk_lid_9.quaternion.copy(endpoint_trunk_lid_9.quaternion);
  }
  mesh_trunk_lid_9.castShadow = options.castShadow ?? true;
  mesh_trunk_lid_9.receiveShadow = options.receiveShadow ?? true;
  mesh_trunk_lid_9.userData.sculptComponent = {"id": "trunk-lid", "name": "Rounded trunk lid", "level": "meso", "role": "hinged panel", "importance": 0.78, "confidence": 0.88, "primitive": "curve-sweep", "topologyClass": "conforming-shell", "topologyRationale": "Rounded trunk lid is represented as conforming-shell because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "conforming-shell procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "rear-deck", "attachment": {"parentId": "rear-deck", "parentSocket": "socket-rear-deck-trunk-lid", "localStart": [0, 0, 0], "localEnd": [0.39, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.78, "height": 0.1, "depth": 1.04, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.34, 0.98, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "hinge", "pivot": {"mode": "component-origin", "localPosition": [0.36, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-trunk-lid", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.78, 0.1, 1.04], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "trunk-lid", "seamRefs": ["trunk-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}}, "material": "body-paint", "materialLayers": ["body-paint"], "deformations": [], "joints": [], "seams": ["trunk-gap"], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(8, 10, 9, 1)", "secondaryAlbedo": "rgba(17, 21, 19, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_trunk_lid_9.add(mesh_trunk_lid_9);
  meshes["trunk-lid"] = mesh_trunk_lid_9;
  ...
  destructionGroups["trunk-lid"].push(node_trunk_lid_9);
  ...
  node_trunk_lid_9.add(socket_trunk_lid_socket_trunk_lid_0);
  sockets["trunk-lid:socket-trunk-lid"] = socket_trunk_lid_socket_trunk_lid_0;

  const attachment_door_system_10 = {"parentId": "body-shell", "parentSocket": "socket-body-shell-door-system", "localStart": [0, 0, 0], "localEnd": [0.59, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_door_system_10 = makeAttachmentEndpoint(attachment_door_system_10);
  const node_door_system_10 = new THREE.Group();
  node_door_system_10.name = "Paired side-hinged doors__pivot";
  if (endpoint_door_system_10) {
    node_door_system_10.position.copy(endpoint_door_system_10.start);
    node_door_system_10.rotation.set(0, 0, 0);
    node_door_system_10.scale.set(1, 1, 1);
  } else {
    node_door_system_10.position.set(-0.38, 0.72, 0.0);
    node_door_system_10.rotation.set(0.0, 0.0, 0.0);
    node_door_system_10.scale.set(1.0, 1.0, 1.0);
  }
  node_door_system_10.userData.sculptComponent = {"id": "door-system", "name": "Paired side-hinged doors", "level": "meso", "role": "hinged door", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "conforming-shell", "topologyRationale": "Paired side-hinged doors is represented as conforming-shell because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "conforming-shell procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "body-shell", "attachment": {"parentId": "body-shell", "parentSocket": "socket-body-shell-door-system", "localStart": [0, 0, 0], "localEnd": [0.59, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 1.18, "height": 0.62, "depth": 1.52, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.38, 0.72, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "hinge-pair", "pivot": {"mode": "component-origin", "localPosition": [0.52, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-door-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.18, 0.62, 1.52], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "door-system", "seamRefs": ["left-door-gap", "right-door-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}}, "material": "body-paint", "materialLayers": ["body-paint"], "deformations": [], "joints": [], "seams": ["left-door-gap", "right-door-gap"], "localFeatures": [{"id": "door-panel-seams", "type": "seam", "description": "Separate side-hinged doors with narrow perimeter gaps", "scale": "meso", "evidenceRefs": ["references/front-three-quarter.jpg"]}, {"id": "door-handles", "type": "fastener", "description": "Horizontal polished pull handles with round lock cylinders", "scale": "micro", "evidenceRefs": ["references/front-three-quarter.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(8, 10, 9, 1)", "secondaryAlbedo": "rgba(17, 21, 19, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_door_system_10.userData.actionProfile = {"animationRole": "hinge-pair", "pivot": {"mode": "component-origin", "localPosition": [0.52, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-door-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.18, 0.62, 1.52], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "door-system", "seamRefs": ["left-door-gap", "right-door-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}};
  (nodes["body-shell"] ?? root).add(node_door_system_10);
  nodes["door-system"] = node_door_system_10;
  const mesh_door_system_10Geometry = endpoint_door_system_10
    ? new THREE.CylinderGeometry(endpoint_door_system_10.endRadius, endpoint_door_system_10.baseRadius, endpoint_door_system_10.length, 32, 12)
    : buildExtrudeGeometry({"points": [[-0.3, -0.3], [0.3, -0.3], [0.3, 0.3], [-0.3, 0.3]], "depth": 0.1});
  const mesh_door_system_10 = new THREE.Mesh(
    mesh_door_system_10Geometry,
    materialMap["body-paint"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_door_system_10.name = "Paired side-hinged doors";
  if (endpoint_door_system_10) {
    mesh_door_system_10.position.copy(endpoint_door_system_10.midpoint);
    mesh_door_system_10.quaternion.copy(endpoint_door_system_10.quaternion);
  }
  mesh_door_system_10.castShadow = options.castShadow ?? true;
  mesh_door_system_10.receiveShadow = options.receiveShadow ?? true;
  mesh_door_system_10.userData.sculptComponent = {"id": "door-system", "name": "Paired side-hinged doors", "level": "meso", "role": "hinged door", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "conforming-shell", "topologyRationale": "Paired side-hinged doors is represented as conforming-shell because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "conforming-shell procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "body-shell", "attachment": {"parentId": "body-shell", "parentSocket": "socket-body-shell-door-system", "localStart": [0, 0, 0], "localEnd": [0.59, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 1.18, "height": 0.62, "depth": 1.52, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.38, 0.72, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "hinge-pair", "pivot": {"mode": "component-origin", "localPosition": [0.52, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-door-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.18, 0.62, 1.52], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "door-system", "seamRefs": ["left-door-gap", "right-door-gap"], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "body-paint"}}, "material": "body-paint", "materialLayers": ["body-paint"], "deformations": [], "joints": [], "seams": ["left-door-gap", "right-door-gap"], "localFeatures": [{"id": "door-panel-seams", "type": "seam", "description": "Separate side-hinged doors with narrow perimeter gaps", "scale": "meso", "evidenceRefs": ["references/front-three-quarter.jpg"]}, {"id": "door-handles", "type": "fastener", "description": "Horizontal polished pull handles with round lock cylinders", "scale": "micro", "evidenceRefs": ["references/front-three-quarter.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(8, 10, 9, 1)", "secondaryAlbedo": "rgba(17, 21, 19, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_door_system_10.add(mesh_door_system_10);
  meshes["door-system"] = mesh_door_system_10;
  colliders["door-system"] = {"type": "box", "offset": [0, 0, 0], "scale": [1.18, 0.62, 1.52], "isTrigger": false, "notes": "Simplified runtime proxy."};
  destructionGroups["door-system"] ??= [];
  destructionGroups["door-system"].push(node_door_system_10);
  const socket_door_system_socket_door_system_0 = new THREE.Object3D();
  socket_door_system_socket_door_system_0.name = "socket-door-system";
  socket_door_system_socket_door_system_0.position.set(0.0, 0.0, 0.0);
  socket_door_system_socket_door_system_0.rotation.set(0, 0, 0);
  socket_door_system_socket_door_system_0.userData.socket = {"id": "socket-door-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"};
  node_door_system_10.add(socket_door_system_socket_door_system_0);
  sockets["door-system:socket-door-system"] = socket_door_system_socket_door_system_0;

  const attachment_windshield_11 = {"parentId": "cockpit", "parentSocket": "socket-cockpit-windshield", "localStart": [0, 0, 0], "localEnd": [0.04, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_windshield_11 = makeAttachmentEndpoint(attachment_windshield_11);
  const node_windshield_11 = new THREE.Group();
  node_windshield_11.name = "Split windshield and chrome frame__pivot";
  if (endpoint_windshield_11) {
    node_windshield_11.position.copy(endpoint_windshield_11.start);
    node_windshield_11.rotation.set(0, 0, 0);
    node_windshield_11.scale.set(1, 1, 1);
  } else {
    node_windshield_11.position.set(0.18, 1.19, 0.0);
    node_windshield_11.rotation.set(0.0, 0.0, 0.0);
    node_windshield_11.scale.set(1.0, 1.0, 1.0);
  }
  node_windshield_11.userData.sculptComponent = {"id": "windshield", "name": "Split windshield and chrome frame", "level": "meso", "role": "window frame", "importance": 0.78, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Glass panes are conforming shells mounted inside a separate curve-swept metal frame.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["shallow lateral arc", "18-degree rearward rake"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-windshield", "localStart": [0, 0, 0], "localEnd": [0.04, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.08, "height": 0.66, "depth": 1.3, "units": "m", "confidence": 0.88}, "transform": {"position": [0.18, 1.19, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-windshield", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.08, 0.66, 1.3], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "windshield", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "glass"}}, "material": "glass", "materialLayers": ["glass"], "deformations": ["shallow lateral arc", "18-degree rearward rake"], "joints": [], "seams": [], "localFeatures": [{"id": "split-windshield-frame", "type": "ridge", "description": "Low two-pane windshield with polished perimeter and center divider", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "paired-wipers", "type": "fastener", "description": "Two thin chrome wiper arms resting at the windshield base", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(184, 212, 213, 0.28)", "secondaryAlbedo": "rgba(225, 240, 240, 0.18)", "materialClass": "glass", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_windshield_11.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-windshield", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.08, 0.66, 1.3], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "windshield", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "glass"}};
  (nodes["cockpit"] ?? root).add(node_windshield_11);
  nodes["windshield"] = node_windshield_11;
  const mesh_windshield_11Geometry = endpoint_windshield_11
    ? new THREE.CylinderGeometry(endpoint_windshield_11.endRadius, endpoint_windshield_11.baseRadius, endpoint_windshield_11.length, 32, 12)
    : buildTubeGeometry({"points": [[0.0, -0.5, 0.0], [0.0, 0.5, 0.0]], "radius": 0.05, "closed": false});
  const mesh_windshield_11 = new THREE.Mesh(
    mesh_windshield_11Geometry,
    materialMap["glass"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_windshield_11.name = "Split windshield and chrome frame";
  if (endpoint_windshield_11) {
    mesh_windshield_11.position.copy(endpoint_windshield_11.midpoint);
    mesh_windshield_11.quaternion.copy(endpoint_windshield_11.quaternion);
  }
  mesh_windshield_11.castShadow = options.castShadow ?? true;
  mesh_windshield_11.receiveShadow = options.receiveShadow ?? true;
  mesh_windshield_11.userData.sculptComponent = {"id": "windshield", "name": "Split windshield and chrome frame", "level": "meso", "role": "window frame", "importance": 0.78, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Glass panes are conforming shells mounted inside a separate curve-swept metal frame.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["shallow lateral arc", "18-degree rearward rake"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-windshield", "localStart": [0, 0, 0], "localEnd": [0.04, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.08, "height": 0.66, "depth": 1.3, "units": "m", "confidence": 0.88}, "transform": {"position": [0.18, 1.19, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-windshield", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.08, 0.66, 1.3], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "windshield", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "glass"}}, "material": "glass", "materialLayers": ["glass"], "deformations": ["shallow lateral arc", "18-degree rearward rake"], "joints": [], "seams": [], "localFeatures": [{"id": "split-windshield-frame", "type": "ridge", "description": "Low two-pane windshield with polished perimeter and center divider", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "paired-wipers", "type": "fastener", "description": "Two thin chrome wiper arms resting at the windshield base", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(184, 212, 213, 0.28)", "secondaryAlbedo": "rgba(225, 240, 240, 0.18)", "materialClass": "glass", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_windshield_11.add(mesh_windshield_11);
  meshes["windshield"] = mesh_windshield_11;
  ...
  destructionGroups["windshield"].push(node_windshield_11);
  ...
  node_windshield_11.add(socket_windshield_socket_windshield_0);
  sockets["windshield:socket-windshield"] = socket_windshield_socket_windshield_0;

  const attachment_front_grille_12 = {"parentId": "front-clip", "parentSocket": "socket-front-clip-front-grille", "localStart": [0, 0, 0], "localEnd": [0.05, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_front_grille_12 = makeAttachmentEndpoint(attachment_front_grille_12);
  const node_front_grille_12 = new THREE.Group();
  node_front_grille_12.name = "Alfa shield and twin intakes__pivot";
  if (endpoint_front_grille_12) {
    node_front_grille_12.position.copy(endpoint_front_grille_12.start);
    node_front_grille_12.rotation.set(0, 0, 0);
    node_front_grille_12.scale.set(1, 1, 1);
  } else {
    node_front_grille_12.position.set(1.89, 0.64, 0.0);
    node_front_grille_12.rotation.set(0.0, 0.0, 0.0);
    node_front_grille_12.scale.set(1.0, 1.0, 1.0);
  }
  node_front_grille_12.userData.sculptComponent = {"id": "front-grille", "name": "Alfa shield and twin intakes", "level": "meso", "role": "grille", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Alfa shield and twin intakes is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["tapered shield perimeter", "recessed intake voids"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "front-clip", "attachment": {"parentId": "front-clip", "parentSocket": "socket-front-clip-front-grille", "localStart": [0, 0, 0], "localEnd": [0.05, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.1, "height": 0.52, "depth": 1.13, "units": "m", "confidence": 0.88}, "transform": {"position": [1.89, 0.64, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-grille", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.1, 0.52, 1.13], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-grille", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": ["tapered shield perimeter", "recessed intake voids"], "joints": [], "seams": [], "localFeatures": [{"id": "alfa-shield-grille", "type": "hole", "description": "Triangular chrome shield grille with inset vertical and horizontal bars", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "twin-front-intakes", "type": "linework", "description": "Two black horizontal intake voids bounded by chrome rails", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "alfa-crest", "type": "decal", "description": "Round Alfa crest at the shield grille crown", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_front_grille_12.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-grille", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.1, 0.52, 1.13], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-grille", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}};
  (nodes["front-clip"] ?? root).add(node_front_grille_12);
  nodes["front-grille"] = node_front_grille_12;
  const mesh_front_grille_12Geometry = endpoint_front_grille_12
    ? new THREE.CylinderGeometry(endpoint_front_grille_12.endRadius, endpoint_front_grille_12.baseRadius, endpoint_front_grille_12.length, 32, 12)
    : buildExtrudeGeometry({"points": [[-0.3, -0.3], [0.3, -0.3], [0.3, 0.3], [-0.3, 0.3]], "depth": 0.1});
  const mesh_front_grille_12 = new THREE.Mesh(
    mesh_front_grille_12Geometry,
    materialMap["chrome"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_front_grille_12.name = "Alfa shield and twin intakes";
  if (endpoint_front_grille_12) {
    mesh_front_grille_12.position.copy(endpoint_front_grille_12.midpoint);
    mesh_front_grille_12.quaternion.copy(endpoint_front_grille_12.quaternion);
  }
  mesh_front_grille_12.castShadow = options.castShadow ?? true;
  mesh_front_grille_12.receiveShadow = options.receiveShadow ?? true;
  mesh_front_grille_12.userData.sculptComponent = {"id": "front-grille", "name": "Alfa shield and twin intakes", "level": "meso", "role": "grille", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Alfa shield and twin intakes is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["tapered shield perimeter", "recessed intake voids"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "front-clip", "attachment": {"parentId": "front-clip", "parentSocket": "socket-front-clip-front-grille", "localStart": [0, 0, 0], "localEnd": [0.05, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.1, "height": 0.52, "depth": 1.13, "units": "m", "confidence": 0.88}, "transform": {"position": [1.89, 0.64, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-grille", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.1, 0.52, 1.13], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-grille", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": ["tapered shield perimeter", "recessed intake voids"], "joints": [], "seams": [], "localFeatures": [{"id": "alfa-shield-grille", "type": "hole", "description": "Triangular chrome shield grille with inset vertical and horizontal bars", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "twin-front-intakes", "type": "linework", "description": "Two black horizontal intake voids bounded by chrome rails", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}, {"id": "alfa-crest", "type": "decal", "description": "Round Alfa crest at the shield grille crown", "scale": "micro", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_front_grille_12.add(mesh_front_grille_12);
  meshes["front-grille"] = mesh_front_grille_12;
  ...
  destructionGroups["front-grille"].push(node_front_grille_12);
  ...
  mesh_front_bumper_13.userData.sculptComponent = {"id": "front-bumper", "name": "Front chrome blade and overriders", "level": "meso", "role": "bumper", "importance": 0.78, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Front chrome blade and overriders is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["wraparound lateral curvature"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "front-clip", "attachment": {"parentId": "front-clip", "parentSocket": "socket-front-clip-front-bumper", "localStart": [0, 0, 0], "localEnd": [0.075, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.15, "height": 0.2, "depth": 1.46, "units": "m", "confidence": 0.88}, "transform": {"position": [1.97, 0.39, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-bumper", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.15, 0.2, 1.46], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-bumper", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": ["wraparound lateral curvature"], "joints": [], "seams": [], "localFeatures": [{"id": "front-overriders", "type": "ridge", "description": "Paired vertical chrome bumper overriders with rounded caps", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  ...
  node_front_bumper_13.add(socket_front_bumper_socket_front_bumper_0);
  sockets["front-bumper:socket-front-bumper"] = socket_front_bumper_socket_front_bumper_0;

  const attachment_rear_bumper_14 = {"parentId": "rear-deck", "parentSocket": "socket-rear-deck-rear-bumper", "localStart": [0, 0, 0], "localEnd": [0.075, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_rear_bumper_14 = makeAttachmentEndpoint(attachment_rear_bumper_14);
  const node_rear_bumper_14 = new THREE.Group();
  node_rear_bumper_14.name = "Rear chrome blade and overriders__pivot";
  if (endpoint_rear_bumper_14) {
    node_rear_bumper_14.position.copy(endpoint_rear_bumper_14.start);
    node_rear_bumper_14.rotation.set(0, 0, 0);
    node_rear_bumper_14.scale.set(1, 1, 1);
  } else {
    node_rear_bumper_14.position.set(-1.94, 0.42, 0.0);
    node_rear_bumper_14.rotation.set(0.0, 0.0, 0.0);
    node_rear_bumper_14.scale.set(1.0, 1.0, 1.0);
  }
  node_rear_bumper_14.userData.sculptComponent = {"id": "rear-bumper", "name": "Rear chrome blade and overriders", "level": "meso", "role": "bumper", "importance": 0.78, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Rear chrome blade and overriders is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["wraparound lateral curvature"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "rear-deck", "attachment": {"parentId": "rear-deck", "parentSocket": "socket-rear-deck-rear-bumper", "localStart": [0, 0, 0], "localEnd": [0.075, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.15, "height": 0.22, "depth": 1.46, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.94, 0.42, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-bumper", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.15, 0.22, 1.46], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-bumper", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": ["wraparound lateral curvature"], "joints": [], "seams": [], "localFeatures": [{"id": "rear-bumper-overriders", "type": "ridge", "description": "Rear chrome blade bumper with paired vertical overriders", "scale": "meso", "evidenceRefs": ["references/rear-three-quarter.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_bumper_14.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-bumper", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.15, 0.22, 1.46], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-bumper", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}};
  (nodes["rear-deck"] ?? root).add(node_rear_bumper_14);
  nodes["rear-bumper"] = node_rear_bumper_14;
  const mesh_rear_bumper_14Geometry = endpoint_rear_bumper_14
    ? new THREE.CylinderGeometry(endpoint_rear_bumper_14.endRadius, endpoint_rear_bumper_14.baseRadius, endpoint_rear_bumper_14.length, 32, 12)
    : buildTubeGeometry({"points": [[0.0, -0.5, 0.0], [0.0, 0.5, 0.0]], "radius": 0.05, "closed": false});
  const mesh_rear_bumper_14 = new THREE.Mesh(
    mesh_rear_bumper_14Geometry,
    materialMap["chrome"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rear_bumper_14.name = "Rear chrome blade and overriders";
  if (endpoint_rear_bumper_14) {
    mesh_rear_bumper_14.position.copy(endpoint_rear_bumper_14.midpoint);
    mesh_rear_bumper_14.quaternion.copy(endpoint_rear_bumper_14.quaternion);
  }
  mesh_rear_bumper_14.castShadow = options.castShadow ?? true;
  mesh_rear_bumper_14.receiveShadow = options.receiveShadow ?? true;
  mesh_rear_bumper_14.userData.sculptComponent = {"id": "rear-bumper", "name": "Rear chrome blade and overriders", "level": "meso", "role": "bumper", "importance": 0.78, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Rear chrome blade and overriders is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["wraparound lateral curvature"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "rear-deck", "attachment": {"parentId": "rear-deck", "parentSocket": "socket-rear-deck-rear-bumper", "localStart": [0, 0, 0], "localEnd": [0.075, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.15, "height": 0.22, "depth": 1.46, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.94, 0.42, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-bumper", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.15, 0.22, 1.46], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-bumper", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": ["wraparound lateral curvature"], "joints": [], "seams": [], "localFeatures": [{"id": "rear-bumper-overriders", "type": "ridge", "description": "Rear chrome blade bumper with paired vertical overriders", "scale": "meso", "evidenceRefs": ["references/rear-three-quarter.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_bumper_14.add(mesh_rear_bumper_14);
  meshes["rear-bumper"] = mesh_rear_bumper_14;
  ...
  destructionGroups["rear-bumper"].push(node_rear_bumper_14);
  ...
  node_rear_bumper_14.add(socket_rear_bumper_socket_rear_bumper_0);
  sockets["rear-bumper:socket-rear-bumper"] = socket_rear_bumper_socket_rear_bumper_0;

  const attachment_front_lighting_15 = {"parentId": "front-fender-system", "parentSocket": "socket-front-fender-system-front-lighting", "localStart": [0, 0, 0], "localEnd": [0.125, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_front_lighting_15 = makeAttachmentEndpoint(attachment_front_lighting_15);
  const node_front_lighting_15 = new THREE.Group();
  node_front_lighting_15.name = "Headlamps and front indicators__pivot";
  if (endpoint_front_lighting_15) {
    node_front_lighting_15.position.copy(endpoint_front_lighting_15.start);
    node_front_lighting_15.rotation.set(0, 0, 0);
    node_front_lighting_15.scale.set(1, 1, 1);
  } else {
    node_front_lighting_15.position.set(1.64, 0.78, 0.0);
    node_front_lighting_15.rotation.set(0.0, 0.0, 0.0);
    node_front_lighting_15.scale.set(1.0, 1.0, 1.0);
  }
  node_front_lighting_15.userData.sculptComponent = {"id": "front-lighting", "name": "Headlamps and front indicators", "level": "meso", "role": "lamp assembly", "importance": 0.78, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Paired circular lens, bezel, and reflector solids are separate attached assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "front-fender-system", "attachment": {"parentId": "front-fender-system", "parentSocket": "socket-front-fender-system-front-lighting", "localStart": [0, 0, 0], "localEnd": [0.125, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.25, "height": 0.31, "depth": 1.35, "units": "m", "confidence": 0.88}, "transform": {"position": [1.64, 0.78, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-lighting", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.25, 0.31, 1.35], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-lighting", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "lamp-glass"}}, "material": "lamp-glass", "materialLayers": ["lamp-glass"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "round-headlamps", "type": "gloss", "description": "Large circular glass headlamps in chrome bezels at fender noses", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(231, 229, 213, 0.72)", "secondaryAlbedo": "rgba(255, 250, 224, 0.55)", "materialClass": "glass", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_front_lighting_15.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-lighting", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.25, 0.31, 1.35], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-lighting", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "lamp-glass"}};
  (nodes["front-fender-system"] ?? root).add(node_front_lighting_15);
  nodes["front-lighting"] = node_front_lighting_15;
  const mesh_front_lighting_15Geometry = endpoint_front_lighting_15
    ? new THREE.CylinderGeometry(endpoint_front_lighting_15.endRadius, endpoint_front_lighting_15.baseRadius, endpoint_front_lighting_15.length, 32, 12)
    : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  const mesh_front_lighting_15 = new THREE.Mesh(
    mesh_front_lighting_15Geometry,
    materialMap["lamp-glass"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_front_lighting_15.name = "Headlamps and front indicators";
  if (endpoint_front_lighting_15) {
    mesh_front_lighting_15.position.copy(endpoint_front_lighting_15.midpoint);
    mesh_front_lighting_15.quaternion.copy(endpoint_front_lighting_15.quaternion);
  }
  mesh_front_lighting_15.castShadow = options.castShadow ?? true;
  mesh_front_lighting_15.receiveShadow = options.receiveShadow ?? true;
  mesh_front_lighting_15.userData.sculptComponent = {"id": "front-lighting", "name": "Headlamps and front indicators", "level": "meso", "role": "lamp assembly", "importance": 0.78, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Paired circular lens, bezel, and reflector solids are separate attached assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "front-fender-system", "attachment": {"parentId": "front-fender-system", "parentSocket": "socket-front-fender-system-front-lighting", "localStart": [0, 0, 0], "localEnd": [0.125, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.25, "height": 0.31, "depth": 1.35, "units": "m", "confidence": 0.88}, "transform": {"position": [1.64, 0.78, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-lighting", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.25, 0.31, 1.35], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-lighting", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "lamp-glass"}}, "material": "lamp-glass", "materialLayers": ["lamp-glass"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "round-headlamps", "type": "gloss", "description": "Large circular glass headlamps in chrome bezels at fender noses", "scale": "meso", "evidenceRefs": ["references/front-close.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(231, 229, 213, 0.72)", "secondaryAlbedo": "rgba(255, 250, 224, 0.55)", "materialClass": "glass", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_front_lighting_15.add(mesh_front_lighting_15);
  meshes["front-lighting"] = mesh_front_lighting_15;
  ...
  destructionGroups["front-lighting"].push(node_front_lighting_15);
  ...
  node_front_lighting_15.add(socket_front_lighting_socket_front_lighting_0);
  sockets["front-lighting:socket-front-lighting"] = socket_front_lighting_socket_front_lighting_0;

  const attachment_rear_lighting_16 = {"parentId": "rear-fender-system", "parentSocket": "socket-rear-fender-system-rear-lighting", "localStart": [0, 0, 0], "localEnd": [0.06, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_rear_lighting_16 = makeAttachmentEndpoint(attachment_rear_lighting_16);
  const node_rear_lighting_16 = new THREE.Group();
  node_rear_lighting_16.name = "Vertical tail lamp stacks__pivot";
  if (endpoint_rear_lighting_16) {
    node_rear_lighting_16.position.copy(endpoint_rear_lighting_16.start);
    node_rear_lighting_16.rotation.set(0, 0, 0);
    node_rear_lighting_16.scale.set(1, 1, 1);
  } else {
    node_rear_lighting_16.position.set(-1.73, 0.67, 0.0);
    node_rear_lighting_16.rotation.set(0.0, 0.0, 0.0);
    node_rear_lighting_16.scale.set(1.0, 1.0, 1.0);
  }
  node_rear_lighting_16.userData.sculptComponent = {"id": "rear-lighting", "name": "Vertical tail lamp stacks", "level": "meso", "role": "lamp assembly", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Vertical tail lamp stacks is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "rear-fender-system", "attachment": {"parentId": "rear-fender-system", "parentSocket": "socket-rear-fender-system-rear-lighting", "localStart": [0, 0, 0], "localEnd": [0.06, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.12, "height": 0.38, "depth": 1.34, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.73, 0.67, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-lighting", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.12, 0.38, 1.34], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-lighting", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "red-lens"}}, "material": "red-lens", "materialLayers": ["red-lens"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "rear-tail-lamps", "type": "gloss", "description": "Vertical amber and red rear lamp stacks in chrome housings", "scale": "meso", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(157, 16, 19, 0.9)", "secondaryAlbedo": "rgba(210, 123, 11, 0.9)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_lighting_16.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-lighting", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.12, 0.38, 1.34], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-lighting", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "red-lens"}};
  (nodes["rear-fender-system"] ?? root).add(node_rear_lighting_16);
  nodes["rear-lighting"] = node_rear_lighting_16;
  const mesh_rear_lighting_16Geometry = endpoint_rear_lighting_16
    ? new THREE.CylinderGeometry(endpoint_rear_lighting_16.endRadius, endpoint_rear_lighting_16.baseRadius, endpoint_rear_lighting_16.length, 32, 12)
    : buildExtrudeGeometry({"points": [[-0.3, -0.3], [0.3, -0.3], [0.3, 0.3], [-0.3, 0.3]], "depth": 0.1});
  const mesh_rear_lighting_16 = new THREE.Mesh(
    mesh_rear_lighting_16Geometry,
    materialMap["red-lens"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rear_lighting_16.name = "Vertical tail lamp stacks";
  if (endpoint_rear_lighting_16) {
    mesh_rear_lighting_16.position.copy(endpoint_rear_lighting_16.midpoint);
    mesh_rear_lighting_16.quaternion.copy(endpoint_rear_lighting_16.quaternion);
  }
  mesh_rear_lighting_16.castShadow = options.castShadow ?? true;
  mesh_rear_lighting_16.receiveShadow = options.receiveShadow ?? true;
  mesh_rear_lighting_16.userData.sculptComponent = {"id": "rear-lighting", "name": "Vertical tail lamp stacks", "level": "meso", "role": "lamp assembly", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Vertical tail lamp stacks is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "rear-fender-system", "attachment": {"parentId": "rear-fender-system", "parentSocket": "socket-rear-fender-system-rear-lighting", "localStart": [0, 0, 0], "localEnd": [0.06, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.12, "height": 0.38, "depth": 1.34, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.73, 0.67, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-lighting", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.12, 0.38, 1.34], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-lighting", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "red-lens"}}, "material": "red-lens", "materialLayers": ["red-lens"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "rear-tail-lamps", "type": "gloss", "description": "Vertical amber and red rear lamp stacks in chrome housings", "scale": "meso", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(157, 16, 19, 0.9)", "secondaryAlbedo": "rgba(210, 123, 11, 0.9)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_lighting_16.add(mesh_rear_lighting_16);
  meshes["rear-lighting"] = mesh_rear_lighting_16;
  ...
  destructionGroups["rear-lighting"].push(node_rear_lighting_16);
  ...
  node_rear_lighting_16.add(socket_rear_lighting_socket_rear_lighting_0);
  sockets["rear-lighting:socket-rear-lighting"] = socket_rear_lighting_socket_rear_lighting_0;

  const attachment_seat_system_17 = {"parentId": "cockpit", "parentSocket": "socket-cockpit-seat-system", "localStart": [0, 0, 0], "localEnd": [0.46, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_seat_system_17 = makeAttachmentEndpoint(attachment_seat_system_17);
  const node_seat_system_17 = new THREE.Group();
  node_seat_system_17.name = "Oxblood bucket seats and rear squab__pivot";
  if (endpoint_seat_system_17) {
    node_seat_system_17.position.copy(endpoint_seat_system_17.start);
    node_seat_system_17.rotation.set(0, 0, 0);
    node_seat_system_17.scale.set(1, 1, 1);
  } else {
    node_seat_system_17.position.set(-0.55, 0.82, 0.0);
    node_seat_system_17.rotation.set(0.0, 0.0, 0.0);
    node_seat_system_17.scale.set(1.0, 1.0, 1.0);
  }
  node_seat_system_17.userData.sculptComponent = {"id": "seat-system", "name": "Oxblood bucket seats and rear squab", "level": "meso", "role": "seat assembly", "importance": 0.78, "confidence": 0.88, "primitive": "ellipsoid", "topologyClass": "continuous-sculpt", "topologyRationale": "Upholstered cushions require continuous rounded volumes rather than box stacks.", "geometryDescriptor": {"topologyIntent": "continuous-sculpt procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["rounded bolsters", "repeated pleats"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-seat-system", "localStart": [0, 0, 0], "localEnd": [0.46, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.92, "height": 0.72, "depth": 1.08, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.55, 0.82, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-seat-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.92, 0.72, 1.08], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "seat-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "red-leather"}}, "material": "red-leather", "materialLayers": ["red-leather"], "deformations": ["rounded bolsters", "repeated pleats"], "joints": [], "seams": [], "localFeatures": [{"id": "seat-pleats", "type": "linework", "description": "Repeated horizontal pleats across both bucket-seat cushions", "scale": "micro", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(143, 23, 27, 1)", "secondaryAlbedo": "rgba(187, 41, 45, 1)", "materialClass": "fabric", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_seat_system_17.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-seat-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.92, 0.72, 1.08], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "seat-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "red-leather"}};
  (nodes["cockpit"] ?? root).add(node_seat_system_17);
  nodes["seat-system"] = node_seat_system_17;
  const mesh_seat_system_17Geometry = endpoint_seat_system_17
    ? new THREE.CylinderGeometry(endpoint_seat_system_17.endRadius, endpoint_seat_system_17.baseRadius, endpoint_seat_system_17.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  const mesh_seat_system_17 = new THREE.Mesh(
    mesh_seat_system_17Geometry,
    materialMap["red-leather"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_seat_system_17.name = "Oxblood bucket seats and rear squab";
  if (endpoint_seat_system_17) {
    mesh_seat_system_17.position.copy(endpoint_seat_system_17.midpoint);
    mesh_seat_system_17.quaternion.copy(endpoint_seat_system_17.quaternion);
  }
  mesh_seat_system_17.castShadow = options.castShadow ?? true;
  mesh_seat_system_17.receiveShadow = options.receiveShadow ?? true;
  mesh_seat_system_17.userData.sculptComponent = {"id": "seat-system", "name": "Oxblood bucket seats and rear squab", "level": "meso", "role": "seat assembly", "importance": 0.78, "confidence": 0.88, "primitive": "ellipsoid", "topologyClass": "continuous-sculpt", "topologyRationale": "Upholstered cushions require continuous rounded volumes rather than box stacks.", "geometryDescriptor": {"topologyIntent": "continuous-sculpt procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["rounded bolsters", "repeated pleats"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-seat-system", "localStart": [0, 0, 0], "localEnd": [0.46, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.92, "height": 0.72, "depth": 1.08, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.55, 0.82, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-seat-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.92, 0.72, 1.08], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "seat-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "red-leather"}}, "material": "red-leather", "materialLayers": ["red-leather"], "deformations": ["rounded bolsters", "repeated pleats"], "joints": [], "seams": [], "localFeatures": [{"id": "seat-pleats", "type": "linework", "description": "Repeated horizontal pleats across both bucket-seat cushions", "scale": "micro", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(143, 23, 27, 1)", "secondaryAlbedo": "rgba(187, 41, 45, 1)", "materialClass": "fabric", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_seat_system_17.add(mesh_seat_system_17);
  meshes["seat-system"] = mesh_seat_system_17;
  colliders["seat-system"] = {"type": "box", "offset": [0, 0, 0], "scale": [0.92, 0.72, 1.08], "isTrigger": false, "notes": "Simplified runtime proxy."};
  destructionGroups["seat-system"] ??= [];
  destructionGroups["seat-system"].push(node_seat_system_17);
  const socket_seat_system_socket_seat_system_0 = new THREE.Object3D();
  socket_seat_system_socket_seat_system_0.name = "socket-seat-system";
  socket_seat_system_socket_seat_system_0.position.set(0.0, 0.0, 0.0);
  socket_seat_system_socket_seat_system_0.rotation.set(0, 0, 0);
  socket_seat_system_socket_seat_system_0.userData.socket = {"id": "socket-seat-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"};
  node_seat_system_17.add(socket_seat_system_socket_seat_system_0);
  sockets["seat-system:socket-seat-system"] = socket_seat_system_socket_seat_system_0;

  const attachment_dashboard_18 = {"parentId": "cockpit", "parentSocket": "socket-cockpit-dashboard", "localStart": [0, 0, 0], "localEnd": [0.11, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_dashboard_18 = makeAttachmentEndpoint(attachment_dashboard_18);
  const node_dashboard_18 = new THREE.Group();
  node_dashboard_18.name = "Right-hand-drive dashboard__pivot";
  if (endpoint_dashboard_18) {
    node_dashboard_18.position.copy(endpoint_dashboard_18.start);
    node_dashboard_18.rotation.set(0, 0, 0);
    node_dashboard_18.scale.set(1, 1, 1);
  } else {
    node_dashboard_18.position.set(0.08, 1.02, 0.0);
    node_dashboard_18.rotation.set(0.0, 0.0, 0.0);
    node_dashboard_18.scale.set(1.0, 1.0, 1.0);
  }
  node_dashboard_18.userData.sculptComponent = {"id": "dashboard", "name": "Right-hand-drive dashboard", "level": "meso", "role": "control panel", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Right-hand-drive dashboard is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["shallow padded top arc"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-dashboard", "localStart": [0, 0, 0], "localEnd": [0.11, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.22, "height": 0.35, "depth": 1.18, "units": "m", "confidence": 0.88}, "transform": {"position": [0.08, 1.02, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-dashboard", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.22, 0.35, 1.18], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "dashboard", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "cabin-black"}}, "material": "cabin-black", "materialLayers": ["cabin-black"], "deformations": ["shallow padded top arc"], "joints": [], "seams": [], "localFeatures": [{"id": "three-gauge-cluster", "type": "ridge", "description": "Three circular black gauges with chrome bezels behind the steering wheel", "scale": "micro", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(23, 22, 21, 1)", "secondaryAlbedo": "rgba(40, 37, 34, 1)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_dashboard_18.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-dashboard", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.22, 0.35, 1.18], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "dashboard", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "cabin-black"}};
  (nodes["cockpit"] ?? root).add(node_dashboard_18);
  nodes["dashboard"] = node_dashboard_18;
  const mesh_dashboard_18Geometry = endpoint_dashboard_18
    ? new THREE.CylinderGeometry(endpoint_dashboard_18.endRadius, endpoint_dashboard_18.baseRadius, endpoint_dashboard_18.length, 32, 12)
    : buildExtrudeGeometry({"points": [[-0.3, -0.3], [0.3, -0.3], [0.3, 0.3], [-0.3, 0.3]], "depth": 0.1});
  const mesh_dashboard_18 = new THREE.Mesh(
    mesh_dashboard_18Geometry,
    materialMap["cabin-black"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_dashboard_18.name = "Right-hand-drive dashboard";
  if (endpoint_dashboard_18) {
    mesh_dashboard_18.position.copy(endpoint_dashboard_18.midpoint);
    mesh_dashboard_18.quaternion.copy(endpoint_dashboard_18.quaternion);
  }
  mesh_dashboard_18.castShadow = options.castShadow ?? true;
  mesh_dashboard_18.receiveShadow = options.receiveShadow ?? true;
  mesh_dashboard_18.userData.sculptComponent = {"id": "dashboard", "name": "Right-hand-drive dashboard", "level": "meso", "role": "control panel", "importance": 0.78, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Right-hand-drive dashboard is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": ["shallow padded top arc"], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-dashboard", "localStart": [0, 0, 0], "localEnd": [0.11, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.22, "height": 0.35, "depth": 1.18, "units": "m", "confidence": 0.88}, "transform": {"position": [0.08, 1.02, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-dashboard", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.22, 0.35, 1.18], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "dashboard", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "cabin-black"}}, "material": "cabin-black", "materialLayers": ["cabin-black"], "deformations": ["shallow padded top arc"], "joints": [], "seams": [], "localFeatures": [{"id": "three-gauge-cluster", "type": "ridge", "description": "Three circular black gauges with chrome bezels behind the steering wheel", "scale": "micro", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(23, 22, 21, 1)", "secondaryAlbedo": "rgba(40, 37, 34, 1)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_dashboard_18.add(mesh_dashboard_18);
  meshes["dashboard"] = mesh_dashboard_18;
  ...
  destructionGroups["dashboard"].push(node_dashboard_18);
  ...
  node_dashboard_18.add(socket_dashboard_socket_dashboard_0);
  sockets["dashboard:socket-dashboard"] = socket_dashboard_socket_dashboard_0;

  const attachment_steering_system_19 = {"parentId": "dashboard", "parentSocket": "socket-dashboard-steering-system", "localStart": [0, 0, 0], "localEnd": [0.23, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_steering_system_19 = makeAttachmentEndpoint(attachment_steering_system_19);
  const node_steering_system_19 = new THREE.Group();
  node_steering_system_19.name = "Three-spoke steering wheel and column__pivot";
  if (endpoint_steering_system_19) {
    node_steering_system_19.position.copy(endpoint_steering_system_19.start);
    node_steering_system_19.rotation.set(0, 0, 0);
    node_steering_system_19.scale.set(1, 1, 1);
  } else {
    node_steering_system_19.position.set(-0.01, 1.03, -0.38);
    node_steering_system_19.rotation.set(0.0, 0.0, 0.0);
    node_steering_system_19.scale.set(1.0, 1.0, 1.0);
  }
  node_steering_system_19.userData.sculptComponent = {"id": "steering-system", "name": "Three-spoke steering wheel and column", "level": "meso", "role": "steering wheel", "importance": 0.78, "confidence": 0.88, "primitive": "torus", "topologyClass": "assembled-solid", "topologyRationale": "Independent torus rim, spokes, hub, and column form a rotational control assembly.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "dashboard", "attachment": {"parentId": "dashboard", "parentSocket": "socket-dashboard-steering-system", "localStart": [0, 0, 0], "localEnd": [0.23, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.46, "height": 0.46, "depth": 0.22, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.01, 1.03, -0.38], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "rotational-control", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [1, 0, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-steering-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.46, 0.46, 0.22], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "steering-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "cabin-black"}}, "material": "cabin-black", "materialLayers": ["cabin-black"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "three-spoke-wheel", "type": "hole", "description": "Black steering rim with three brushed-metal slotted spokes", "scale": "meso", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(23, 22, 21, 1)", "secondaryAlbedo": "rgba(40, 37, 34, 1)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_steering_system_19.userData.actionProfile = {"animationRole": "rotational-control", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [1, 0, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-steering-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.46, 0.46, 0.22], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "steering-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "cabin-black"}};
  (nodes["dashboard"] ?? root).add(node_steering_system_19);
  nodes["steering-system"] = node_steering_system_19;
  const mesh_steering_system_19Geometry = endpoint_steering_system_19
    ? new THREE.CylinderGeometry(endpoint_steering_system_19.endRadius, endpoint_steering_system_19.baseRadius, endpoint_steering_system_19.length, 32, 12)
    : new THREE.TorusGeometry(0.45, 0.08, 24, 96);
  const mesh_steering_system_19 = new THREE.Mesh(
    mesh_steering_system_19Geometry,
    materialMap["cabin-black"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_steering_system_19.name = "Three-spoke steering wheel and column";
  if (endpoint_steering_system_19) {
    mesh_steering_system_19.position.copy(endpoint_steering_system_19.midpoint);
    mesh_steering_system_19.quaternion.copy(endpoint_steering_system_19.quaternion);
  }
  mesh_steering_system_19.castShadow = options.castShadow ?? true;
  mesh_steering_system_19.receiveShadow = options.receiveShadow ?? true;
  mesh_steering_system_19.userData.sculptComponent = {"id": "steering-system", "name": "Three-spoke steering wheel and column", "level": "meso", "role": "steering wheel", "importance": 0.78, "confidence": 0.88, "primitive": "torus", "topologyClass": "assembled-solid", "topologyRationale": "Independent torus rim, spokes, hub, and column form a rotational control assembly.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "dashboard", "attachment": {"parentId": "dashboard", "parentSocket": "socket-dashboard-steering-system", "localStart": [0, 0, 0], "localEnd": [0.23, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.46, "height": 0.46, "depth": 0.22, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.01, 1.03, -0.38], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "rotational-control", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [1, 0, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-steering-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.46, 0.46, 0.22], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "steering-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "cabin-black"}}, "material": "cabin-black", "materialLayers": ["cabin-black"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "three-spoke-wheel", "type": "hole", "description": "Black steering rim with three brushed-metal slotted spokes", "scale": "meso", "evidenceRefs": ["references/cabin-right.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(23, 22, 21, 1)", "secondaryAlbedo": "rgba(40, 37, 34, 1)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_steering_system_19.add(mesh_steering_system_19);
  meshes["steering-system"] = mesh_steering_system_19;
  ...
  destructionGroups["steering-system"].push(node_steering_system_19);
  ...
  node_steering_system_19.add(socket_steering_system_socket_steering_system_0);
  sockets["steering-system:socket-steering-system"] = socket_steering_system_socket_steering_system_0;

  const attachment_gauge_cluster_20 = {"parentId": "dashboard", "parentSocket": "socket-dashboard-gauge-cluster", "localStart": [0, 0, 0], "localEnd": [0.06, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_gauge_cluster_20 = makeAttachmentEndpoint(attachment_gauge_cluster_20);
  const node_gauge_cluster_20 = new THREE.Group();
  node_gauge_cluster_20.name = "Three circular instrument gauges__pivot";
  if (endpoint_gauge_cluster_20) {
    node_gauge_cluster_20.position.copy(endpoint_gauge_cluster_20.start);
    node_gauge_cluster_20.rotation.set(0, 0, 0);
    node_gauge_cluster_20.scale.set(1, 1, 1);
  } else {
    node_gauge_cluster_20.position.set(0.1, 1.12, -0.26);
    node_gauge_cluster_20.rotation.set(0.0, 0.0, 0.0);
    node_gauge_cluster_20.scale.set(1.0, 1.0, 1.0);
  }
  node_gauge_cluster_20.userData.sculptComponent = {"id": "gauge-cluster", "name": "Three circular instrument gauges", "level": "meso", "role": "gauge assembly", "importance": 0.78, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Three circular instrument gauges is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "dashboard", "attachment": {"parentId": "dashboard", "parentSocket": "socket-dashboard-gauge-cluster", "localStart": [0, 0, 0], "localEnd": [0.06, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.12, "height": 0.24, "depth": 0.54, "units": "m", "confidence": 0.88}, "transform": {"position": [0.1, 1.12, -0.26], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-gauge-cluster", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.12, 0.24, 0.54], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "gauge-cluster", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "gauge-black"}}, "material": "gauge-black", "materialLayers": ["gauge-black"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(9, 10, 9, 1)", "secondaryAlbedo": "rgba(216, 212, 198, 1)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_gauge_cluster_20.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-gauge-cluster", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.12, 0.24, 0.54], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "gauge-cluster", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "gauge-black"}};
  (nodes["dashboard"] ?? root).add(node_gauge_cluster_20);
  nodes["gauge-cluster"] = node_gauge_cluster_20;
  const mesh_gauge_cluster_20Geometry = endpoint_gauge_cluster_20
    ? new THREE.CylinderGeometry(endpoint_gauge_cluster_20.endRadius, endpoint_gauge_cluster_20.baseRadius, endpoint_gauge_cluster_20.length, 32, 12)
    : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  const mesh_gauge_cluster_20 = new THREE.Mesh(
    mesh_gauge_cluster_20Geometry,
    materialMap["gauge-black"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_gauge_cluster_20.name = "Three circular instrument gauges";
  if (endpoint_gauge_cluster_20) {
    mesh_gauge_cluster_20.position.copy(endpoint_gauge_cluster_20.midpoint);
    mesh_gauge_cluster_20.quaternion.copy(endpoint_gauge_cluster_20.quaternion);
  }
  mesh_gauge_cluster_20.castShadow = options.castShadow ?? true;
  mesh_gauge_cluster_20.receiveShadow = options.receiveShadow ?? true;
  mesh_gauge_cluster_20.userData.sculptComponent = {"id": "gauge-cluster", "name": "Three circular instrument gauges", "level": "meso", "role": "gauge assembly", "importance": 0.78, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Three circular instrument gauges is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "dashboard", "attachment": {"parentId": "dashboard", "parentSocket": "socket-dashboard-gauge-cluster", "localStart": [0, 0, 0], "localEnd": [0.06, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.12, "height": 0.24, "depth": 0.54, "units": "m", "confidence": 0.88}, "transform": {"position": [0.1, 1.12, -0.26], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-gauge-cluster", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.12, 0.24, 0.54], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "gauge-cluster", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "gauge-black"}}, "material": "gauge-black", "materialLayers": ["gauge-black"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(9, 10, 9, 1)", "secondaryAlbedo": "rgba(216, 212, 198, 1)", "materialClass": "plastic", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_gauge_cluster_20.add(mesh_gauge_cluster_20);
  meshes["gauge-cluster"] = mesh_gauge_cluster_20;
  ...
  destructionGroups["gauge-cluster"].push(node_gauge_cluster_20);
  ...
  node_gauge_cluster_20.add(socket_gauge_cluster_socket_gauge_cluster_0);
  sockets["gauge-cluster:socket-gauge-cluster"] = socket_gauge_cluster_socket_gauge_cluster_0;

  const attachment_side_brightwork_21 = {"parentId": "body-shell", "parentSocket": "socket-body-shell-side-brightwork", "localStart": [0, 0, 0], "localEnd": [0.85, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_side_brightwork_21 = makeAttachmentEndpoint(attachment_side_brightwork_21);
  const node_side_brightwork_21 = new THREE.Group();
  node_side_brightwork_21.name = "Beltline trim and door handles__pivot";
  if (endpoint_side_brightwork_21) {
    node_side_brightwork_21.position.copy(endpoint_side_brightwork_21.start);
    node_side_brightwork_21.rotation.set(0, 0, 0);
    node_side_brightwork_21.scale.set(1, 1, 1);
  } else {
    node_side_brightwork_21.position.set(-0.3, 0.9, 0.0);
    node_side_brightwork_21.rotation.set(0.0, 0.0, 0.0);
    node_side_brightwork_21.scale.set(1.0, 1.0, 1.0);
  }
  node_side_brightwork_21.userData.sculptComponent = {"id": "side-brightwork", "name": "Beltline trim and door handles", "level": "meso", "role": "trim system", "importance": 0.78, "confidence": 0.88, "primitive": "tube", "topologyClass": "surface-relief", "topologyRationale": "Beltline trim and door handles is represented as surface-relief because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "surface-relief procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "body-shell", "attachment": {"parentId": "body-shell", "parentSocket": "socket-body-shell-side-brightwork", "localStart": [0, 0, 0], "localEnd": [0.85, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 1.7, "height": 0.08, "depth": 1.58, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.3, 0.9, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-side-brightwork", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.7, 0.08, 1.58], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "side-brightwork", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_side_brightwork_21.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-side-brightwork", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.7, 0.08, 1.58], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "side-brightwork", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}};
  (nodes["body-shell"] ?? root).add(node_side_brightwork_21);
  nodes["side-brightwork"] = node_side_brightwork_21;
  const mesh_side_brightwork_21Geometry = endpoint_side_brightwork_21
    ? new THREE.CylinderGeometry(endpoint_side_brightwork_21.endRadius, endpoint_side_brightwork_21.baseRadius, endpoint_side_brightwork_21.length, 32, 12)
    : buildTubeGeometry({"points": [[0.0, -0.5, 0.0], [0.0, 0.5, 0.0]], "radius": 0.05, "closed": false});
  const mesh_side_brightwork_21 = new THREE.Mesh(
    mesh_side_brightwork_21Geometry,
    materialMap["chrome"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_side_brightwork_21.name = "Beltline trim and door handles";
  if (endpoint_side_brightwork_21) {
    mesh_side_brightwork_21.position.copy(endpoint_side_brightwork_21.midpoint);
    mesh_side_brightwork_21.quaternion.copy(endpoint_side_brightwork_21.quaternion);
  }
  mesh_side_brightwork_21.castShadow = options.castShadow ?? true;
  mesh_side_brightwork_21.receiveShadow = options.receiveShadow ?? true;
  mesh_side_brightwork_21.userData.sculptComponent = {"id": "side-brightwork", "name": "Beltline trim and door handles", "level": "meso", "role": "trim system", "importance": 0.78, "confidence": 0.88, "primitive": "tube", "topologyClass": "surface-relief", "topologyRationale": "Beltline trim and door handles is represented as surface-relief because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "surface-relief procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "body-shell", "attachment": {"parentId": "body-shell", "parentSocket": "socket-body-shell-side-brightwork", "localStart": [0, 0, 0], "localEnd": [0.85, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 1.7, "height": 0.08, "depth": 1.58, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.3, 0.9, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-side-brightwork", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1.7, 0.08, 1.58], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "side-brightwork", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_side_brightwork_21.add(mesh_side_brightwork_21);
  meshes["side-brightwork"] = mesh_side_brightwork_21;
  colliders["side-brightwork"] = {"type": "box", "offset": [0, 0, 0], "scale": [1.7, 0.08, 1.58], "isTrigger": false, "notes": "Simplified runtime proxy."};
  destructionGroups["side-brightwork"] ??= [];
  destructionGroups["side-brightwork"].push(node_side_brightwork_21);
  const socket_side_brightwork_socket_side_brightwork_0 = new THREE.Object3D();
  socket_side_brightwork_socket_side_brightwork_0.name = "socket-side-brightwork";
  socket_side_brightwork_socket_side_brightwork_0.position.set(0.0, 0.0, 0.0);
  socket_side_brightwork_socket_side_brightwork_0.rotation.set(0, 0, 0);
  socket_side_brightwork_socket_side_brightwork_0.userData.socket = {"id": "socket-side-brightwork", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"};
  node_side_brightwork_21.add(socket_side_brightwork_socket_side_brightwork_0);
  sockets["side-brightwork:socket-side-brightwork"] = socket_side_brightwork_socket_side_brightwork_0;

  const attachment_floor_chassis_22 = {"parentId": "root", "parentSocket": "socket-root-floor-chassis", "localStart": [0, 0, 0], "localEnd": [1.625, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_floor_chassis_22 = makeAttachmentEndpoint(attachment_floor_chassis_22);
  const node_floor_chassis_22 = new THREE.Group();
  node_floor_chassis_22.name = "Dark underbody and axle occlusion__pivot";
  if (endpoint_floor_chassis_22) {
    node_floor_chassis_22.position.copy(endpoint_floor_chassis_22.start);
    node_floor_chassis_22.rotation.set(0, 0, 0);
    node_floor_chassis_22.scale.set(1, 1, 1);
  } else {
    node_floor_chassis_22.position.set(-0.05, 0.28, 0.0);
    node_floor_chassis_22.rotation.set(0.0, 0.0, 0.0);
    node_floor_chassis_22.scale.set(1.0, 1.0, 1.0);
  }
  node_floor_chassis_22.userData.sculptComponent = {"id": "floor-chassis", "name": "Dark underbody and axle occlusion", "level": "meso", "role": "chassis proxy", "importance": 0.78, "confidence": 0.3, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "Dark underbody and axle occlusion is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "socket-root-floor-chassis", "localStart": [0, 0, 0], "localEnd": [1.625, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 3.25, "height": 0.22, "depth": 1.17, "units": "m", "confidence": 0.3}, "transform": {"position": [-0.05, 0.28, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.3}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-floor-chassis", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [3.25, 0.22, 1.17], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "floor-chassis", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "utility-dark"}}, "material": "utility-dark", "materialLayers": ["utility-dark"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(10, 11, 11, 1)", "secondaryAlbedo": "rgba(18, 19, 19, 1)", "materialClass": "plastic", "materialClassConfidence": 0.3, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_floor_chassis_22.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.3}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-floor-chassis", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [3.25, 0.22, 1.17], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "floor-chassis", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "utility-dark"}};
  (nodes["root"] ?? root).add(node_floor_chassis_22);
  nodes["floor-chassis"] = node_floor_chassis_22;
  const mesh_floor_chassis_22Geometry = endpoint_floor_chassis_22
    ? new THREE.CylinderGeometry(endpoint_floor_chassis_22.endRadius, endpoint_floor_chassis_22.baseRadius, endpoint_floor_chassis_22.length, 32, 12)
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  const mesh_floor_chassis_22 = new THREE.Mesh(
    mesh_floor_chassis_22Geometry,
    materialMap["utility-dark"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_floor_chassis_22.name = "Dark underbody and axle occlusion";
  if (endpoint_floor_chassis_22) {
    mesh_floor_chassis_22.position.copy(endpoint_floor_chassis_22.midpoint);
    mesh_floor_chassis_22.quaternion.copy(endpoint_floor_chassis_22.quaternion);
  }
  mesh_floor_chassis_22.castShadow = options.castShadow ?? true;
  mesh_floor_chassis_22.receiveShadow = options.receiveShadow ?? true;
  mesh_floor_chassis_22.userData.sculptComponent = {"id": "floor-chassis", "name": "Dark underbody and axle occlusion", "level": "meso", "role": "chassis proxy", "importance": 0.78, "confidence": 0.3, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "Dark underbody and axle occlusion is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "socket-root-floor-chassis", "localStart": [0, 0, 0], "localEnd": [1.625, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 3.25, "height": 0.22, "depth": 1.17, "units": "m", "confidence": 0.3}, "transform": {"position": [-0.05, 0.28, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.3}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-floor-chassis", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [3.25, 0.22, 1.17], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "floor-chassis", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "utility-dark"}}, "material": "utility-dark", "materialLayers": ["utility-dark"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(10, 11, 11, 1)", "secondaryAlbedo": "rgba(18, 19, 19, 1)", "materialClass": "plastic", "materialClassConfidence": 0.3, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_floor_chassis_22.add(mesh_floor_chassis_22);
  meshes["floor-chassis"] = mesh_floor_chassis_22;
  ...
  destructionGroups["floor-chassis"].push(node_floor_chassis_22);
  ...
  node_floor_chassis_22.add(socket_floor_chassis_socket_floor_chassis_0);
  sockets["floor-chassis:socket-floor-chassis"] = socket_floor_chassis_socket_floor_chassis_0;

  const attachment_exhaust_23 = {"parentId": "floor-chassis", "parentSocket": "socket-floor-chassis-exhaust", "localStart": [0, 0, 0], "localEnd": [-0.6, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_exhaust_23 = makeAttachmentEndpoint(attachment_exhaust_23);
  const node_exhaust_23 = new THREE.Group();
  node_exhaust_23.name = "Single rear exhaust pipe__pivot";
  if (endpoint_exhaust_23) {
    node_exhaust_23.position.copy(endpoint_exhaust_23.start);
    node_exhaust_23.rotation.set(0, 0, 0);
    node_exhaust_23.scale.set(1, 1, 1);
  } else {
    node_exhaust_23.position.set(-1.82, 0.27, 0.46);
    node_exhaust_23.rotation.set(0.0, 0.0, 0.0);
    node_exhaust_23.scale.set(1.0, 1.0, 1.0);
  }
  node_exhaust_23.userData.sculptComponent = {"id": "exhaust", "name": "Single rear exhaust pipe", "level": "meso", "role": "exhaust tube", "importance": 0.78, "confidence": 0.78, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Single rear exhaust pipe is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "floor-chassis", "attachment": {"parentId": "floor-chassis", "parentSocket": "socket-floor-chassis-exhaust", "localStart": [0, 0, 0], "localEnd": [-0.6, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.62, "height": 0.08, "depth": 0.08, "units": "m", "confidence": 0.78}, "transform": {"position": [-1.82, 0.27, 0.46], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.78}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-exhaust", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.62, 0.08, 0.08], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "exhaust", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "dark-metal"}}, "material": "dark-metal", "materialLayers": ["dark-metal"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "exhaust-tip", "type": "ridge", "description": "Single dark circular exhaust outlet under the left rear", "scale": "micro", "evidenceRefs": ["references/rear-three-quarter.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(37, 39, 39, 1)", "secondaryAlbedo": "rgba(8, 9, 9, 1)", "materialClass": "metal", "materialClassConfidence": 0.78, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_exhaust_23.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.78}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-exhaust", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.62, 0.08, 0.08], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "exhaust", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "dark-metal"}};
  (nodes["floor-chassis"] ?? root).add(node_exhaust_23);
  nodes["exhaust"] = node_exhaust_23;
  const mesh_exhaust_23Geometry = endpoint_exhaust_23
    ? new THREE.CylinderGeometry(endpoint_exhaust_23.endRadius, endpoint_exhaust_23.baseRadius, endpoint_exhaust_23.length, 32, 12)
    : buildTubeGeometry({"points": [[0.0, -0.5, 0.0], [0.0, 0.5, 0.0]], "radius": 0.05, "closed": false});
  const mesh_exhaust_23 = new THREE.Mesh(
    mesh_exhaust_23Geometry,
    materialMap["dark-metal"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_exhaust_23.name = "Single rear exhaust pipe";
  if (endpoint_exhaust_23) {
    mesh_exhaust_23.position.copy(endpoint_exhaust_23.midpoint);
    mesh_exhaust_23.quaternion.copy(endpoint_exhaust_23.quaternion);
  }
  mesh_exhaust_23.castShadow = options.castShadow ?? true;
  mesh_exhaust_23.receiveShadow = options.receiveShadow ?? true;
  mesh_exhaust_23.userData.sculptComponent = {"id": "exhaust", "name": "Single rear exhaust pipe", "level": "meso", "role": "exhaust tube", "importance": 0.78, "confidence": 0.78, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Single rear exhaust pipe is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "floor-chassis", "attachment": {"parentId": "floor-chassis", "parentSocket": "socket-floor-chassis-exhaust", "localStart": [0, 0, 0], "localEnd": [-0.6, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.62, "height": 0.08, "depth": 0.08, "units": "m", "confidence": 0.78}, "transform": {"position": [-1.82, 0.27, 0.46], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.78}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-exhaust", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.62, 0.08, 0.08], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "exhaust", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "dark-metal"}}, "material": "dark-metal", "materialLayers": ["dark-metal"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "exhaust-tip", "type": "ridge", "description": "Single dark circular exhaust outlet under the left rear", "scale": "micro", "evidenceRefs": ["references/rear-three-quarter.jpg"]}], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "hero", "colorMaterialRecipe": {"dominantAlbedo": "rgba(37, 39, 39, 1)", "secondaryAlbedo": "rgba(8, 9, 9, 1)", "materialClass": "metal", "materialClassConfidence": 0.78, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_exhaust_23.add(mesh_exhaust_23);
  meshes["exhaust"] = mesh_exhaust_23;
  ...
  destructionGroups["exhaust"].push(node_exhaust_23);
  ...
  node_exhaust_23.add(socket_exhaust_socket_exhaust_0);
  sockets["exhaust:socket-exhaust"] = socket_exhaust_socket_exhaust_0;

  const attachment_front_wheel_left_24 = {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-front-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_front_wheel_left_24 = makeAttachmentEndpoint(attachment_front_wheel_left_24);
  const node_front_wheel_left_24 = new THREE.Group();
  node_front_wheel_left_24.name = "Front left wheel pivot__pivot";
  if (endpoint_front_wheel_left_24) {
    node_front_wheel_left_24.position.copy(endpoint_front_wheel_left_24.start);
    node_front_wheel_left_24.rotation.set(0, 0, 0);
    node_front_wheel_left_24.scale.set(1, 1, 1);
  } else {
    node_front_wheel_left_24.position.set(1.14, 0.43, 0.73);
    node_front_wheel_left_24.rotation.set(0.0, 0.0, 0.0);
    node_front_wheel_left_24.scale.set(1.0, 1.0, 1.0);
  }
  node_front_wheel_left_24.userData.sculptComponent = {"id": "front-wheel-left", "name": "Front left wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Front left wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-front-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [1.14, 0.43, 0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "steered-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-wheel-left", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-wheel-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  ...
  (nodes["wheel-system"] ?? root).add(node_front_wheel_left_24);
  nodes["front-wheel-left"] = node_front_wheel_left_24;
  const mesh_front_wheel_left_24Geometry = endpoint_front_wheel_left_24
    ? new THREE.CylinderGeometry(endpoint_front_wheel_left_24.endRadius, endpoint_front_wheel_left_24.baseRadius, endpoint_front_wheel_left_24.length, 32, 12)
    : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  const mesh_front_wheel_left_24 = new THREE.Mesh(
    mesh_front_wheel_left_24Geometry,
    materialMap["rubber"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_front_wheel_left_24.name = "Front left wheel pivot";
  if (endpoint_front_wheel_left_24) {
    mesh_front_wheel_left_24.position.copy(endpoint_front_wheel_left_24.midpoint);
    mesh_front_wheel_left_24.quaternion.copy(endpoint_front_wheel_left_24.quaternion);
  }
  mesh_front_wheel_left_24.castShadow = options.castShadow ?? true;
  mesh_front_wheel_left_24.receiveShadow = options.receiveShadow ?? true;
  mesh_front_wheel_left_24.userData.sculptComponent = {"id": "front-wheel-left", "name": "Front left wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Front left wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-front-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [1.14, 0.43, 0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "steered-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-wheel-left", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-wheel-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_front_wheel_left_24.add(mesh_front_wheel_left_24);
  meshes["front-wheel-left"] = mesh_front_wheel_left_24;
  ...
  destructionGroups["front-wheel-left"].push(node_front_wheel_left_24);
  ...
  node_front_wheel_left_24.add(socket_front_wheel_left_socket_front_wheel_left_0);
  sockets["front-wheel-left:socket-front-wheel-left"] = socket_front_wheel_left_socket_front_wheel_left_0;

  const attachment_front_wheel_right_25 = {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-front-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_front_wheel_right_25 = makeAttachmentEndpoint(attachment_front_wheel_right_25);
  const node_front_wheel_right_25 = new THREE.Group();
  node_front_wheel_right_25.name = "Front right wheel pivot__pivot";
  if (endpoint_front_wheel_right_25) {
    node_front_wheel_right_25.position.copy(endpoint_front_wheel_right_25.start);
    node_front_wheel_right_25.rotation.set(0, 0, 0);
    node_front_wheel_right_25.scale.set(1, 1, 1);
  } else {
    node_front_wheel_right_25.position.set(1.14, 0.43, -0.73);
    node_front_wheel_right_25.rotation.set(0.0, 0.0, 0.0);
    node_front_wheel_right_25.scale.set(1.0, 1.0, 1.0);
  }
  node_front_wheel_right_25.userData.sculptComponent = {"id": "front-wheel-right", "name": "Front right wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Front right wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-front-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [1.14, 0.43, -0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "steered-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-wheel-right", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-wheel-right", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_front_wheel_right_25.userData.actionProfile = {"animationRole": "steered-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-wheel-right", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-wheel-right", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}};
  (nodes["wheel-system"] ?? root).add(node_front_wheel_right_25);
  nodes["front-wheel-right"] = node_front_wheel_right_25;
  const mesh_front_wheel_right_25Geometry = endpoint_front_wheel_right_25
    ? new THREE.CylinderGeometry(endpoint_front_wheel_right_25.endRadius, endpoint_front_wheel_right_25.baseRadius, endpoint_front_wheel_right_25.length, 32, 12)
    : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  const mesh_front_wheel_right_25 = new THREE.Mesh(
    mesh_front_wheel_right_25Geometry,
    materialMap["rubber"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_front_wheel_right_25.name = "Front right wheel pivot";
  if (endpoint_front_wheel_right_25) {
    mesh_front_wheel_right_25.position.copy(endpoint_front_wheel_right_25.midpoint);
    mesh_front_wheel_right_25.quaternion.copy(endpoint_front_wheel_right_25.quaternion);
  }
  mesh_front_wheel_right_25.castShadow = options.castShadow ?? true;
  mesh_front_wheel_right_25.receiveShadow = options.receiveShadow ?? true;
  mesh_front_wheel_right_25.userData.sculptComponent = {"id": "front-wheel-right", "name": "Front right wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Front right wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-front-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [1.14, 0.43, -0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "steered-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-front-wheel-right", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "front-wheel-right", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_front_wheel_right_25.add(mesh_front_wheel_right_25);
  meshes["front-wheel-right"] = mesh_front_wheel_right_25;
  ...
  destructionGroups["front-wheel-right"].push(node_front_wheel_right_25);
  ...
  node_front_wheel_right_25.add(socket_front_wheel_right_socket_front_wheel_right_0);
  sockets["front-wheel-right:socket-front-wheel-right"] = socket_front_wheel_right_socket_front_wheel_right_0;

  const attachment_rear_wheel_left_26 = {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-rear-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_rear_wheel_left_26 = makeAttachmentEndpoint(attachment_rear_wheel_left_26);
  const node_rear_wheel_left_26 = new THREE.Group();
  node_rear_wheel_left_26.name = "Rear left wheel pivot__pivot";
  if (endpoint_rear_wheel_left_26) {
    node_rear_wheel_left_26.position.copy(endpoint_rear_wheel_left_26.start);
    node_rear_wheel_left_26.rotation.set(0, 0, 0);
    node_rear_wheel_left_26.scale.set(1, 1, 1);
  } else {
    node_rear_wheel_left_26.position.set(-1.15, 0.43, 0.73);
    node_rear_wheel_left_26.rotation.set(0.0, 0.0, 0.0);
    node_rear_wheel_left_26.scale.set(1.0, 1.0, 1.0);
  }
  node_rear_wheel_left_26.userData.sculptComponent = {"id": "rear-wheel-left", "name": "Rear left wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Rear left wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-rear-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.15, 0.43, 0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "rotating-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-wheel-left", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-wheel-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_wheel_left_26.userData.actionProfile = {"animationRole": "rotating-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-wheel-left", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-wheel-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}};
  (nodes["wheel-system"] ?? root).add(node_rear_wheel_left_26);
  nodes["rear-wheel-left"] = node_rear_wheel_left_26;
  const mesh_rear_wheel_left_26Geometry = endpoint_rear_wheel_left_26
    ? new THREE.CylinderGeometry(endpoint_rear_wheel_left_26.endRadius, endpoint_rear_wheel_left_26.baseRadius, endpoint_rear_wheel_left_26.length, 32, 12)
    : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  const mesh_rear_wheel_left_26 = new THREE.Mesh(
    mesh_rear_wheel_left_26Geometry,
    materialMap["rubber"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rear_wheel_left_26.name = "Rear left wheel pivot";
  if (endpoint_rear_wheel_left_26) {
    mesh_rear_wheel_left_26.position.copy(endpoint_rear_wheel_left_26.midpoint);
    mesh_rear_wheel_left_26.quaternion.copy(endpoint_rear_wheel_left_26.quaternion);
  }
  mesh_rear_wheel_left_26.castShadow = options.castShadow ?? true;
  mesh_rear_wheel_left_26.receiveShadow = options.receiveShadow ?? true;
  mesh_rear_wheel_left_26.userData.sculptComponent = {"id": "rear-wheel-left", "name": "Rear left wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Rear left wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-rear-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.15, 0.43, 0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "rotating-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-wheel-left", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-wheel-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_wheel_left_26.add(mesh_rear_wheel_left_26);
  meshes["rear-wheel-left"] = mesh_rear_wheel_left_26;
  ...
  destructionGroups["rear-wheel-left"].push(node_rear_wheel_left_26);
  ...
  node_rear_wheel_left_26.add(socket_rear_wheel_left_socket_rear_wheel_left_0);
  sockets["rear-wheel-left:socket-rear-wheel-left"] = socket_rear_wheel_left_socket_rear_wheel_left_0;

  const attachment_rear_wheel_right_27 = {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-rear-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_rear_wheel_right_27 = makeAttachmentEndpoint(attachment_rear_wheel_right_27);
  const node_rear_wheel_right_27 = new THREE.Group();
  node_rear_wheel_right_27.name = "Rear right wheel pivot__pivot";
  if (endpoint_rear_wheel_right_27) {
    node_rear_wheel_right_27.position.copy(endpoint_rear_wheel_right_27.start);
    node_rear_wheel_right_27.rotation.set(0, 0, 0);
    node_rear_wheel_right_27.scale.set(1, 1, 1);
  } else {
    node_rear_wheel_right_27.position.set(-1.15, 0.43, -0.73);
    node_rear_wheel_right_27.rotation.set(0.0, 0.0, 0.0);
    node_rear_wheel_right_27.scale.set(1.0, 1.0, 1.0);
  }
  node_rear_wheel_right_27.userData.sculptComponent = {"id": "rear-wheel-right", "name": "Rear right wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Rear right wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-rear-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.15, 0.43, -0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "rotating-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-wheel-right", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-wheel-right", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_wheel_right_27.userData.actionProfile = {"animationRole": "rotating-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-wheel-right", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-wheel-right", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}};
  (nodes["wheel-system"] ?? root).add(node_rear_wheel_right_27);
  nodes["rear-wheel-right"] = node_rear_wheel_right_27;
  const mesh_rear_wheel_right_27Geometry = endpoint_rear_wheel_right_27
    ? new THREE.CylinderGeometry(endpoint_rear_wheel_right_27.endRadius, endpoint_rear_wheel_right_27.baseRadius, endpoint_rear_wheel_right_27.length, 32, 12)
    : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  const mesh_rear_wheel_right_27 = new THREE.Mesh(
    mesh_rear_wheel_right_27Geometry,
    materialMap["rubber"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rear_wheel_right_27.name = "Rear right wheel pivot";
  if (endpoint_rear_wheel_right_27) {
    mesh_rear_wheel_right_27.position.copy(endpoint_rear_wheel_right_27.midpoint);
    mesh_rear_wheel_right_27.quaternion.copy(endpoint_rear_wheel_right_27.quaternion);
  }
  mesh_rear_wheel_right_27.castShadow = options.castShadow ?? true;
  mesh_rear_wheel_right_27.receiveShadow = options.receiveShadow ?? true;
  mesh_rear_wheel_right_27.userData.sculptComponent = {"id": "rear-wheel-right", "name": "Rear right wheel pivot", "level": "micro", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Rear right wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "wheel-system", "attachment": {"parentId": "wheel-system", "parentSocket": "socket-wheel-system-rear-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.15, 0.43, -0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "rotating-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-wheel-right", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-wheel-right", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_rear_wheel_right_27.add(mesh_rear_wheel_right_27);
  meshes["rear-wheel-right"] = mesh_rear_wheel_right_27;
  ...
  destructionGroups["rear-wheel-right"].push(node_rear_wheel_right_27);
  ...
  node_rear_wheel_right_27.add(socket_rear_wheel_right_socket_rear_wheel_right_0);
  sockets["rear-wheel-right:socket-rear-wheel-right"] = socket_rear_wheel_right_socket_rear_wheel_right_0;

  const attachment_wiper_system_28 = {"parentId": "windshield", "parentSocket": "socket-windshield-wiper-system", "localStart": [0, 0, 0], "localEnd": [0.21, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_wiper_system_28 = makeAttachmentEndpoint(attachment_wiper_system_28);
  const node_wiper_system_28 = new THREE.Group();
  node_wiper_system_28.name = "Paired windshield wipers__pivot";
  if (endpoint_wiper_system_28) {
    node_wiper_system_28.position.copy(endpoint_wiper_system_28.start);
    node_wiper_system_28.rotation.set(0, 0, 0);
    node_wiper_system_28.scale.set(1, 1, 1);
  } else {
    node_wiper_system_28.position.set(0.16, 1.0, 0.0);
    node_wiper_system_28.rotation.set(0.0, 0.0, 0.0);
    node_wiper_system_28.scale.set(1.0, 1.0, 1.0);
  }
  node_wiper_system_28.userData.sculptComponent = {"id": "wiper-system", "name": "Paired windshield wipers", "level": "micro", "role": "wiper arm", "importance": 0.55, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Paired windshield wipers is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "windshield", "attachment": {"parentId": "windshield", "parentSocket": "socket-windshield-wiper-system", "localStart": [0, 0, 0], "localEnd": [0.21, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.42, "height": 0.03, "depth": 0.64, "units": "m", "confidence": 0.88}, "transform": {"position": [0.16, 1, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-wiper-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.42, 0.03, 0.64], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "wiper-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_wiper_system_28.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-wiper-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.42, 0.03, 0.64], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "wiper-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}};
  (nodes["windshield"] ?? root).add(node_wiper_system_28);
  nodes["wiper-system"] = node_wiper_system_28;
  const mesh_wiper_system_28Geometry = endpoint_wiper_system_28
    ? new THREE.CylinderGeometry(endpoint_wiper_system_28.endRadius, endpoint_wiper_system_28.baseRadius, endpoint_wiper_system_28.length, 32, 12)
    : buildTubeGeometry({"points": [[0.0, -0.5, 0.0], [0.0, 0.5, 0.0]], "radius": 0.05, "closed": false});
  const mesh_wiper_system_28 = new THREE.Mesh(
    mesh_wiper_system_28Geometry,
    materialMap["chrome"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_wiper_system_28.name = "Paired windshield wipers";
  if (endpoint_wiper_system_28) {
    mesh_wiper_system_28.position.copy(endpoint_wiper_system_28.midpoint);
    mesh_wiper_system_28.quaternion.copy(endpoint_wiper_system_28.quaternion);
  }
  mesh_wiper_system_28.castShadow = options.castShadow ?? true;
  mesh_wiper_system_28.receiveShadow = options.receiveShadow ?? true;
  mesh_wiper_system_28.userData.sculptComponent = {"id": "wiper-system", "name": "Paired windshield wipers", "level": "micro", "role": "wiper arm", "importance": 0.55, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Paired windshield wipers is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "windshield", "attachment": {"parentId": "windshield", "parentSocket": "socket-windshield-wiper-system", "localStart": [0, 0, 0], "localEnd": [0.21, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.42, "height": 0.03, "depth": 0.64, "units": "m", "confidence": 0.88}, "transform": {"position": [0.16, 1, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-wiper-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.42, 0.03, 0.64], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "wiper-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_wiper_system_28.add(mesh_wiper_system_28);
  meshes["wiper-system"] = mesh_wiper_system_28;
  colliders["wiper-system"] = {"type": "box", "offset": [0, 0, 0], "scale": [0.42, 0.03, 0.64], "isTrigger": false, "notes": "Simplified runtime proxy."};
  destructionGroups["wiper-system"] ??= [];
  destructionGroups["wiper-system"].push(node_wiper_system_28);
  const socket_wiper_system_socket_wiper_system_0 = new THREE.Object3D();
  socket_wiper_system_socket_wiper_system_0.name = "socket-wiper-system";
  socket_wiper_system_socket_wiper_system_0.position.set(0.0, 0.0, 0.0);
  socket_wiper_system_socket_wiper_system_0.rotation.set(0, 0, 0);
  socket_wiper_system_socket_wiper_system_0.userData.socket = {"id": "socket-wiper-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"};
  node_wiper_system_28.add(socket_wiper_system_socket_wiper_system_0);
  sockets["wiper-system:socket-wiper-system"] = socket_wiper_system_socket_wiper_system_0;

  const attachment_plate_system_29 = {"parentId": "root", "parentSocket": "socket-root-plate-system", "localStart": [0, 0, 0], "localEnd": [1.95, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_plate_system_29 = makeAttachmentEndpoint(attachment_plate_system_29);
  const node_plate_system_29 = new THREE.Group();
  node_plate_system_29.name = "Front and rear Singapore plates__pivot";
  if (endpoint_plate_system_29) {
    node_plate_system_29.position.copy(endpoint_plate_system_29.start);
    node_plate_system_29.rotation.set(0, 0, 0);
    node_plate_system_29.scale.set(1, 1, 1);
  } else {
    node_plate_system_29.position.set(0.0, 0.43, 0.0);
    node_plate_system_29.rotation.set(0.0, 0.0, 0.0);
    node_plate_system_29.scale.set(1.0, 1.0, 1.0);
  }
  node_plate_system_29.userData.sculptComponent = {"id": "plate-system", "name": "Front and rear Singapore plates", "level": "micro", "role": "plate", "importance": 0.55, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Front and rear Singapore plates is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "socket-root-plate-system", "localStart": [0, 0, 0], "localEnd": [1.95, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 3.9, "height": 0.18, "depth": 0.5, "units": "m", "confidence": 0.88}, "transform": {"position": [0, 0.43, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-plate-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [3.9, 0.18, 0.5], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "plate-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "plate"}}, "material": "plate", "materialLayers": ["plate"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(163, 55, 44, 1)", "secondaryAlbedo": "rgba(211, 155, 36, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_plate_system_29.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-plate-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [3.9, 0.18, 0.5], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "plate-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "plate"}};
  (nodes["root"] ?? root).add(node_plate_system_29);
  nodes["plate-system"] = node_plate_system_29;
  const mesh_plate_system_29Geometry = endpoint_plate_system_29
    ? new THREE.CylinderGeometry(endpoint_plate_system_29.endRadius, endpoint_plate_system_29.baseRadius, endpoint_plate_system_29.length, 32, 12)
    : buildExtrudeGeometry({"points": [[-0.3, -0.3], [0.3, -0.3], [0.3, 0.3], [-0.3, 0.3]], "depth": 0.1});
  const mesh_plate_system_29 = new THREE.Mesh(
    mesh_plate_system_29Geometry,
    materialMap["plate"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_plate_system_29.name = "Front and rear Singapore plates";
  if (endpoint_plate_system_29) {
    mesh_plate_system_29.position.copy(endpoint_plate_system_29.midpoint);
    mesh_plate_system_29.quaternion.copy(endpoint_plate_system_29.quaternion);
  }
  mesh_plate_system_29.castShadow = options.castShadow ?? true;
  mesh_plate_system_29.receiveShadow = options.receiveShadow ?? true;
  mesh_plate_system_29.userData.sculptComponent = {"id": "plate-system", "name": "Front and rear Singapore plates", "level": "micro", "role": "plate", "importance": 0.55, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Front and rear Singapore plates is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "socket-root-plate-system", "localStart": [0, 0, 0], "localEnd": [1.95, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 3.9, "height": 0.18, "depth": 0.5, "units": "m", "confidence": 0.88}, "transform": {"position": [0, 0.43, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-plate-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [3.9, 0.18, 0.5], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "plate-system", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "plate"}}, "material": "plate", "materialLayers": ["plate"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(163, 55, 44, 1)", "secondaryAlbedo": "rgba(211, 155, 36, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_plate_system_29.add(mesh_plate_system_29);
  meshes["plate-system"] = mesh_plate_system_29;
  colliders["plate-system"] = {"type": "box", "offset": [0, 0, 0], "scale": [3.9, 0.18, 0.5], "isTrigger": false, "notes": "Simplified runtime proxy."};
  destructionGroups["plate-system"] ??= [];
  destructionGroups["plate-system"].push(node_plate_system_29);
  const socket_plate_system_socket_plate_system_0 = new THREE.Object3D();
  socket_plate_system_socket_plate_system_0.name = "socket-plate-system";
  socket_plate_system_socket_plate_system_0.position.set(0.0, 0.0, 0.0);
  socket_plate_system_socket_plate_system_0.rotation.set(0, 0, 0);
  socket_plate_system_socket_plate_system_0.userData.socket = {"id": "socket-plate-system", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"};
  node_plate_system_29.add(socket_plate_system_socket_plate_system_0);
  sockets["plate-system:socket-plate-system"] = socket_plate_system_socket_plate_system_0;

  const attachment_cockpit_hardware_30 = {"parentId": "cockpit", "parentSocket": "socket-cockpit-cockpit-hardware", "localStart": [0, 0, 0], "localEnd": [0.22, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_cockpit_hardware_30 = makeAttachmentEndpoint(attachment_cockpit_hardware_30);
  const node_cockpit_hardware_30 = new THREE.Group();
  node_cockpit_hardware_30.name = "Door pulls, cranks and latches__pivot";
  if (endpoint_cockpit_hardware_30) {
    node_cockpit_hardware_30.position.copy(endpoint_cockpit_hardware_30.start);
    node_cockpit_hardware_30.rotation.set(0, 0, 0);
    node_cockpit_hardware_30.scale.set(1, 1, 1);
  } else {
    node_cockpit_hardware_30.position.set(-0.3, 0.88, 0.0);
    node_cockpit_hardware_30.rotation.set(0.0, 0.0, 0.0);
    node_cockpit_hardware_30.scale.set(1.0, 1.0, 1.0);
  }
  node_cockpit_hardware_30.userData.sculptComponent = {"id": "cockpit-hardware", "name": "Door pulls, cranks and latches", "level": "micro", "role": "handle assembly", "importance": 0.55, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Door pulls, cranks and latches is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-cockpit-hardware", "localStart": [0, 0, 0], "localEnd": [0.22, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.44, "height": 0.12, "depth": 1.22, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.3, 0.88, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-cockpit-hardware", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.44, 0.12, 1.22], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "cockpit-hardware", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_cockpit_hardware_30.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-cockpit-hardware", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.44, 0.12, 1.22], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "cockpit-hardware", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}};
  (nodes["cockpit"] ?? root).add(node_cockpit_hardware_30);
  nodes["cockpit-hardware"] = node_cockpit_hardware_30;
  const mesh_cockpit_hardware_30Geometry = endpoint_cockpit_hardware_30
    ? new THREE.CylinderGeometry(endpoint_cockpit_hardware_30.endRadius, endpoint_cockpit_hardware_30.baseRadius, endpoint_cockpit_hardware_30.length, 32, 12)
    : buildTubeGeometry({"points": [[0.0, -0.5, 0.0], [0.0, 0.5, 0.0]], "radius": 0.05, "closed": false});
  const mesh_cockpit_hardware_30 = new THREE.Mesh(
    mesh_cockpit_hardware_30Geometry,
    materialMap["chrome"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_cockpit_hardware_30.name = "Door pulls, cranks and latches";
  if (endpoint_cockpit_hardware_30) {
    mesh_cockpit_hardware_30.position.copy(endpoint_cockpit_hardware_30.midpoint);
    mesh_cockpit_hardware_30.quaternion.copy(endpoint_cockpit_hardware_30.quaternion);
  }
  mesh_cockpit_hardware_30.castShadow = options.castShadow ?? true;
  mesh_cockpit_hardware_30.receiveShadow = options.receiveShadow ?? true;
  mesh_cockpit_hardware_30.userData.sculptComponent = {"id": "cockpit-hardware", "name": "Door pulls, cranks and latches", "level": "micro", "role": "handle assembly", "importance": 0.55, "confidence": 0.88, "primitive": "tube", "topologyClass": "assembled-solid", "topologyRationale": "Door pulls, cranks and latches is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "cockpit", "attachment": {"parentId": "cockpit", "parentSocket": "socket-cockpit-cockpit-hardware", "localStart": [0, 0, 0], "localEnd": [0.22, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.44, "height": 0.12, "depth": 1.22, "units": "m", "confidence": 0.88}, "transform": {"position": [-0.3, 0.88, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-cockpit-hardware", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.44, 0.12, 1.22], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "cockpit-hardware", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_cockpit_hardware_30.add(mesh_cockpit_hardware_30);
  meshes["cockpit-hardware"] = mesh_cockpit_hardware_30;
  colliders["cockpit-hardware"] = {"type": "box", "offset": [0, 0, 0], "scale": [0.44, 0.12, 1.22], "isTrigger": false, "notes": "Simplified runtime proxy."};
  destructionGroups["cockpit-hardware"] ??= [];
  destructionGroups["cockpit-hardware"].push(node_cockpit_hardware_30);
  const socket_cockpit_hardware_socket_cockpit_hardware_0 = new THREE.Object3D();
  socket_cockpit_hardware_socket_cockpit_hardware_0.name = "socket-cockpit-hardware";
  socket_cockpit_hardware_socket_cockpit_hardware_0.position.set(0.0, 0.0, 0.0);
  socket_cockpit_hardware_socket_cockpit_hardware_0.rotation.set(0, 0, 0);
  socket_cockpit_hardware_socket_cockpit_hardware_0.userData.socket = {"id": "socket-cockpit-hardware", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"};
  node_cockpit_hardware_30.add(socket_cockpit_hardware_socket_cockpit_hardware_0);
  sockets["cockpit-hardware:socket-cockpit-hardware"] = socket_cockpit_hardware_socket_cockpit_hardware_0;

  const attachment_hood_latches_31 = {"parentId": "hood", "parentSocket": "socket-hood-hood-latches", "localStart": [0, 0, 0], "localEnd": [0.04, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  const endpoint_hood_latches_31 = makeAttachmentEndpoint(attachment_hood_latches_31);
  const node_hood_latches_31 = new THREE.Group();
  node_hood_latches_31.name = "Bonnet latch pair__pivot";
  if (endpoint_hood_latches_31) {
    node_hood_latches_31.position.copy(endpoint_hood_latches_31.start);
    node_hood_latches_31.rotation.set(0, 0, 0);
    node_hood_latches_31.scale.set(1, 1, 1);
  } else {
    node_hood_latches_31.position.set(0.18, 1.01, 0.0);
    node_hood_latches_31.rotation.set(0.0, 0.0, 0.0);
    node_hood_latches_31.scale.set(1.0, 1.0, 1.0);
  }
  node_hood_latches_31.userData.sculptComponent = {"id": "hood-latches", "name": "Bonnet latch pair", "level": "micro", "role": "fastener assembly", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Bonnet latch pair is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "hood", "attachment": {"parentId": "hood", "parentSocket": "socket-hood-hood-latches", "localStart": [0, 0, 0], "localEnd": [0.04, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.08, "height": 0.08, "depth": 1, "units": "m", "confidence": 0.88}, "transform": {"position": [0.18, 1.01, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-hood-latches", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.08, 0.08, 1], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "hood-latches", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_hood_latches_31.userData.actionProfile = {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-hood-latches", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.08, 0.08, 1], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "hood-latches", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}};
  (nodes["hood"] ?? root).add(node_hood_latches_31);
  nodes["hood-latches"] = node_hood_latches_31;
  const mesh_hood_latches_31Geometry = endpoint_hood_latches_31
    ? new THREE.CylinderGeometry(endpoint_hood_latches_31.endRadius, endpoint_hood_latches_31.baseRadius, endpoint_hood_latches_31.length, 32, 12)
    : new THREE.CylinderGeometry(0.5, 0.5, 1, 48, 16);
  const mesh_hood_latches_31 = new THREE.Mesh(
    mesh_hood_latches_31Geometry,
    materialMap["chrome"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_hood_latches_31.name = "Bonnet latch pair";
  if (endpoint_hood_latches_31) {
    mesh_hood_latches_31.position.copy(endpoint_hood_latches_31.midpoint);
    mesh_hood_latches_31.quaternion.copy(endpoint_hood_latches_31.quaternion);
  }
  mesh_hood_latches_31.castShadow = options.castShadow ?? true;
  mesh_hood_latches_31.receiveShadow = options.receiveShadow ?? true;
  mesh_hood_latches_31.userData.sculptComponent = {"id": "hood-latches", "name": "Bonnet latch pair", "level": "micro", "role": "fastener assembly", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Bonnet latch pair is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "hood", "attachment": {"parentId": "hood", "parentSocket": "socket-hood-hood-latches", "localStart": [0, 0, 0], "localEnd": [0.04, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.08, "height": 0.08, "depth": 1, "units": "m", "confidence": 0.88}, "transform": {"position": [0.18, 1.01, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-part", "pivot": {"mode": "component-origin", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-hood-latches", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.08, 0.08, 1], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "hood-latches", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "chrome"}}, "material": "chrome", "materialLayers": ["chrome"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0, "microRoughness": 0, "bumpAmplitude": 0, "normalPattern": "", "displacementPattern": "", "occlusionPattern": "", "edgeWearPattern": "", "notes": ""}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(216, 221, 224, 1)", "secondaryAlbedo": "rgba(245, 247, 246, 1)", "materialClass": "metal", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  node_hood_latches_31.add(mesh_hood_latches_31);
  meshes["hood-latches"] = mesh_hood_latches_31;
  colliders["hood-latches"] = {"type": "box", "offset": [0, 0, 0], "scale": [0.08, 0.08, 1], "isTrigger": false, "notes": "Simplified runtime proxy."};
  destructionGroups["hood-latches"] ??= [];
  destructionGroups["hood-latches"].push(node_hood_latches_31);
  const socket_hood_latches_socket_hood_latches_0 = new THREE.Object3D();
  socket_hood_latches_socket_hood_latches_0.name = "socket-hood-latches";
  socket_hood_latches_socket_hood_latches_0.position.set(0.0, 0.0, 0.0);
  socket_hood_latches_socket_hood_latches_0.rotation.set(0, 0, 0);
  socket_hood_latches_socket_hood_latches_0.userData.socket = {"id": "socket-hood-latches", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"};
  node_hood_latches_31.add(socket_hood_latches_socket_hood_latches_0);
  sockets["hood-latches:socket-hood-latches"] = socket_hood_latches_socket_hood_latches_0;
