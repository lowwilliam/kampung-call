...
export function create1963AlfaRomeoGiuliaSpiderModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const attachment_hood_5 = {"parentId": "body-shell", "parentSocket": "socket-body-shell-hood", "localStart": [0, 0, 0], "localEnd": [0.76, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  const attachment_trunk_lid_6 = {"parentId": "body-shell", "parentSocket": "socket-body-shell-trunk-lid", "localStart": [0, 0, 0], "localEnd": [0.39, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  (nodes["body-shell"] ?? root).add(node_trunk_lid_6);
  ...
  const attachment_front_wheel_left_11 = {"parentId": "root", "parentSocket": "socket-root-front-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  (nodes["root"] ?? root).add(node_front_wheel_left_11);
  ...
  const attachment_front_wheel_right_12 = {"parentId": "root", "parentSocket": "socket-root-front-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  const attachment_rear_wheel_left_13 = {"parentId": "root", "parentSocket": "socket-root-rear-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  node_rear_wheel_left_13.userData.sculptComponent = {"id": "rear-wheel-left", "name": "Rear left wheel pivot", "level": "meso", "role": "wheel", "importance": 0.55, "confidence": 0.88, "primitive": "cylinder", "topologyClass": "assembled-solid", "topologyRationale": "Rear left wheel pivot is represented as assembled-solid because its visible volume and seams remain distinct from adjacent assemblies.", "geometryDescriptor": {"topologyIntent": "assembled-solid procedural real-time mesh with stable normals", "edgeTreatment": {"type": "bevel", "bevelRadius": 0.018, "segments": 3}, "deformationStack": [], "uvStrategy": "generated object-space coordinates", "normalStrategy": "computed vertex normals with bevel continuity"}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "socket-root-rear-wheel-left", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}, "dimensions": {"width": 0.24, "height": 0.66, "depth": 0.66, "units": "m", "confidence": 0.88}, "transform": {"position": [-1.15, 0.43, 0.73], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "rotating-wheel", "pivot": {"mode": "axle-centre", "localPosition": [0, 0, 0], "axis": [0, 0, 1], "confidence": 0.88}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "socket-rear-wheel-left", "localPosition": [0, 0, 0], "purpose": "assembly/explosion origin"}], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [0.24, 0.66, 0.66], "isTrigger": false, "notes": "Simplified runtime proxy."}, "constraints": [], "destruction": {"breakable": true, "fractureGroup": "rear-wheel-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 8, "debrisMaterial": "rubber"}}, "material": "rubber", "materialLayers": ["rubber"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.03, "microRoughness": 0.025, "bumpAmplitude": 0.035, "normalPattern": "circumferential tread blocks", "displacementPattern": "instanced tread geometry", "occlusionPattern": "independent cavity response at seams, recesses and attachment contacts", "edgeWearPattern": "factory-restored finish; minimal bounded edge variation", "notes": "Independent from albedo. Silhouette-affecting seams, tread, pleats, grille bars and hardware are explicit geometry."}, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"], "details": [], "fidelityTier": "detail", "colorMaterialRecipe": {"dominantAlbedo": "rgba(17, 16, 15, 1)", "secondaryAlbedo": "rgba(37, 35, 32, 1)", "materialClass": "rubber", "materialClassConfidence": 0.88, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]}};
  ...
  (nodes["root"] ?? root).add(node_rear_wheel_left_13);
  ...
  const attachment_rear_wheel_right_14 = {"parentId": "root", "parentSocket": "socket-root-rear-wheel-right", "localStart": [0, 0, 0], "localEnd": [0.12, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  const attachment_front_grille_15 = {"parentId": "body-shell", "parentSocket": "socket-body-shell-front-grille", "localStart": [0, 0, 0], "localEnd": [0.05, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  const attachment_front_bumper_17 = {"parentId": "body-shell", "parentSocket": "socket-body-shell-front-bumper", "localStart": [0, 0, 0], "localEnd": [0.075, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
  ...
  const attachment_rear_bumper_19 = {"parentId": "body-shell", "parentSocket": "socket-body-shell-rear-bumper", "localStart": [0, 0, 0], "localEnd": [0.075, 0, 0], "contactType": "surface-mounted", "embedDepth": 0.025, "overlap": 0.025, "gapTolerance": 0.012, "evidenceRefs": ["front-three-quarter", "rear-three-quarter"]};
