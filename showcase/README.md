...
A standalone, draft editorial 3D catalogue for 68 Singapore-connected objects, places and people: 55 game assets plus 13 research-led Lost Heritage reconstructions. Every product card uses a lazy-loaded WebGL viewer with auto-rotation, direct manipulation, zoom, animation playback where available, and a dedicated detail route.
